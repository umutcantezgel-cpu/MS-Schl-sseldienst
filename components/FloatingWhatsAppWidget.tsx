  ...
  return (
    ...
    >
      <svg
        ...
        aria-hidden="true"
      >
        <path d="M12.008 2C6.486 2 2 6.485 2 12.006c0 1.764.464 3.483 1.346 5.003L2 22l5.127-1.342c1.472.822 3.16 1.258 4.881 1.258h.004c5.522 0 10.007-4.484 10.007-10.006A9.957 9.957 0 0019.08 4.93 9.956 9.956 0 0012.008 2z" fill="#25D366"/>
        <path d="M17.511 14.41c-.302-.15-1.785-.882-2.062-.983-.277-.1-.478-.15-.68.151-.2.302-.781.982-.958 1.184-.176.2-.352.226-.654.075a8.212 8.212 0 01-2.42-1.492c-.89-.794-1.49-1.774-1.666-2.076-.176-.301-.019-.464.132-.614.136-.135.302-.352.453-.528.151-.176.202-.301.302-.503.101-.201.05-.377-.025-.528-.076-.151-.68-1.637-.931-2.24-.246-.588-.495-.508-.68-.517-.176-.008-.377-.01-.58-.01a1.116 1.116 0 00-.805.378c-.277.301-1.057 1.03-1.057 2.513 0 1.483 1.082 2.915 1.233 3.116.151.201 2.128 3.245 5.155 4.548.72.31 1.282.495 1.72.635.723.23 1.38.198 1.9.119.58-.086 1.785-.729 2.037-1.433.251-.704.251-1.307.176-1.432-.075-.126-.277-.202-.579-.352z" fill="#FEFEFE"/>
      </svg>
    </a>
  );
}
