...
export default function RouteVisualization({ city }: RouteVisualizationProps) {
    ...
    return (
        <RevealSection className="py-16 md:py-24 bg-[var(--color-slate-50)] border-y border-[var(--border-subtle)] relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative mt-16 md:mt-24">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-12 md:gap-0 relative z-10">
                        ...
                        <div className="flex flex-col items-center flex-1 w-full relative">
                            ...
                            <div className="md:hidden absolute top-[56px] bottom-[-48px] left-1/2 w-0.5 -translate-x-1/2 bg-[var(--color-slate-200)]" />
                            
                            <div className="w-14 h-14 rounded-full bg-white border border-[var(--border-subtle)] shadow-md flex items-center justify-center text-[var(--value-primary)] mb-4 relative bg-clip-padding">
                                <div className="absolute inset-0 bg-[var(--value-primary)]/5 rounded-full" />
                                <MapPin className="w-6 h-6 stroke-[1.5]" />
                            </div>
                            <h3 className="text-lg font-bold text-[var(--text-primary)] text-center">Start: Wetzlar</h3>
                        ...
                        <div className="flex flex-col items-center flex-1 w-full">
                            <div className="w-14 h-14 rounded-full bg-white border-2 border-[var(--value-primary)] shadow-md flex items-center justify-center text-[var(--value-primary)] mb-4 relative z-10">
                            ...
                            <h3 className="text-lg font-bold text-[var(--text-primary)] text-center">Ziel: {city.name}</h3>
                            <p className="text-sm text-[var(--text-tertiary)] text-center mt-1 font-medium text-[var(--color-red-600)] bg-[var(--color-red-50)] px-3 py-1 rounded-full border border-[var(--color-red-100)] inline-block mt-2">
