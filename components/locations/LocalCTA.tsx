        ...
        <section aria-labelledby="cta-heading" className="bg-[var(--color-red-600)] px-[var(--section-px)] py-[var(--space-32)] text-white text-center relative overflow-hidden">
            ...
            <div className="container relative z-10 mx-auto max-w-4xl">
                ...
                <div className="flex flex-col items-center gap-3">
                    <a href="tel:+4964418056544" className="inline-flex items-center justify-center gap-4 bg-white text-[color:var(--color-red-600)] px-10 py-5 rounded-full typo-cta-button text-2xl md:text-3xl shadow-xl hover:scale-105 hover:bg-white/90 transition-all hover:shadow-2xl">
