...
const SITUATIONS: { key: Situation; label: string; emoji: string }[] = [
  { key: "zugefallen", label: "Tür zugefallen", emoji: "🚪" },
  { key: "abgebrochen", label: "Schlüssel abgebrochen", emoji: "🔑" },
  { key: "schliessanlage", label: "Schließanlage wechseln", emoji: "🔒" },
  { key: "sicherheit", label: "Sicherheitstechnik", emoji: "🛡️" },
];
