        ...
        <div className="flex flex-col items-start max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start sm:items-center">
            <div className="flex flex-col items-start gap-1">
              <HeartbeatCTA>
                <a href="tel:+4964418056544" className="inline-flex items-center justify-center h-[52px] px-8 bg-[var(--color-red-500)] hover:bg-[var(--color-red-600)] text-white typo-cta-button rounded-xl transition-all shadow-[var(--shadow-brand-1)] hover:shadow-[var(--shadow-brand-2)] hover:-translate-y-[2px]">
                  Jetzt kontaktieren
                </a>
              </HeartbeatCTA>
