 ...
 return (
   ...
   <div className="mx-auto max-w-7xl px-[var(--section-px)] py-[var(--section-py)] relative z-10">
    ...
    {/* Main Grid */}
     ...
     {/* Brand Column */}
      <div className="col-span-2 mb-8 lg:mb-0 relative">
       <SeoLink href="/" title="Zurück zur Startseite und Schlüssel Schmiede Wetzlar" className="flex items-center justify-center relative z-10 group w-[300px] h-auto transition-all duration-700 hover:scale-105">
       ...
       <div className="mt-5 space-y-2.5">
        ...
        <div className="mt-5 flex items-center gap-3">
          <a href={companyInfo.socialMedia.facebook} target="_blank" rel="noopener noreferrer nofollow" aria-label="Facebook" className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/10 text-[var(--color-charcoal-300)] hover:bg-[var(--color-red-500)] hover:text-white transition-all">
          ...
          <a href="https://www.instagram.com/schluessel_schmiede_wetzlar/" target="_blank" rel="noopener noreferrer nofollow" aria-label="Instagram" className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/10 text-[var(--color-charcoal-300)] hover:bg-[var(--color-red-500)] hover:text-white transition-all">
          ...
          <a href={companyInfo.socialMedia.linkedin} target="_blank" rel="noopener noreferrer nofollow" aria-label="LinkedIn" className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/10 text-[var(--color-charcoal-300)] hover:bg-[var(--color-red-500)] hover:text-white transition-all">
    ...
    {/* Conversion Push CTA (Safety Net) */}
     ...
     {/* Some links might return redirects (like BSI) so we add nofollow to prevent SEO crawler warnings, but keep noopener noreferrer */}
     <div className="mt-12 pt-8 border-t border-white/10">
       ...
       <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-[var(--color-charcoal-400)]">
         <a href="https://www.k-einbruch.de/" target="_blank" rel="noopener noreferrer nofollow" className="hover:text-[var(--color-red-500)] transition-colors">K-EINBRUCH und Polizeiliche Kriminalprävention</a>
         <a href="https://www.bsi.bund.de/" target="_blank" rel="noopener noreferrer nofollow" className="hover:text-[var(--color-red-500)] transition-colors">BSI Sicherheit</a>
         <a href="https://www.hwk-wiesbaden.de/" target="_blank" rel="noopener noreferrer nofollow" className="hover:text-[var(--color-red-500)] transition-colors">Handwerkskammer Wiesbaden</a>
         <a href="https://www.wetzlar.de/" target="_blank" rel="noopener noreferrer nofollow" className="hover:text-[var(--color-red-500)] transition-colors">Stadtverwaltung Wetzlar</a>
         <a href="https://www.polizei.hessen.de/" target="_blank" rel="noopener noreferrer nofollow" className="hover:text-[var(--color-red-500)] transition-colors">Polizei Hessen</a>
         <a href="https://www.verbraucherzentrale-hessen.de/" target="_blank" rel="noopener noreferrer nofollow" className="hover:text-[var(--color-red-500)] transition-colors">Verbraucherzentrale Hessen</a>
         <a href="https://www.kfw.de/kfw.de.html" target="_blank" rel="noopener noreferrer nofollow" className="hover:text-[var(--color-red-500)] transition-colors">KfW Förderung</a>
       </div>
     </div>
    ...
    <div className="mt-8 flex flex-col justify-between gap-4 border-t border-white/10 pt-8 text-xs text-[var(--color-charcoal-500)] lg:flex-row lg:items-center">
     <p className="leading-relaxed">
       © <span suppressHydrationWarning>{new Date().getFullYear()}</span> Schlüssel Schmiede Wetzlar · Alle Rechte vorbehalten. | Festpreis-Garantie Wetzlarer Kernstadt | Webdesign by <a href="https://codayweb.de" className="hover:text-[var(--color-red-500)] transition-colors underline">Coday</a>
     </p>
      <nav aria-label="Rechtliche Informationen">
       <ul className="flex flex-wrap gap-4">
        {config.legal.map((link) => (
         <li key={link.label}>
          <SeoLink href={link.href} className="hover:text-[var(--color-red-500)] transition-colors underline">
           {link.label}
          </SeoLink>
         </li>
        ))}
        <li><SeoLink href="/" className="hover:text-[var(--color-red-500)] transition-colors underline">Startseite</SeoLink></li>
        <li><SeoLink href="/cookie-richtlinie" className="hover:text-[var(--color-red-500)] transition-colors underline">Cookie-Richtlinie</SeoLink></li>
        <li><SeoLink href="/barrierefreiheit" className="hover:text-[var(--color-red-500)] transition-colors underline">Barrierefreiheit</SeoLink></li>
        <li><SeoLink href="/sitemap-uebersicht" className="hover:text-[var(--color-red-500)] transition-colors underline">Sitemap</SeoLink></li>
