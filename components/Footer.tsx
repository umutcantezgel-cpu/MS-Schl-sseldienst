      ...
      <div className="col-span-2 mb-8 lg:mb-0 relative">
       ...
       <div className="mt-5 space-y-2.5">
        ...
        <div className="mt-5 flex items-center gap-3">
          ...
          <a href="https://www.linkedin.com/in/mina-saad-a218413a9/" target="_blank" rel="noopener noreferrer nofollow" aria-label="LinkedIn" className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/10 text-[var(--color-charcoal-300)] hover:bg-[var(--color-red-500)] hover:text-white transition-all">
