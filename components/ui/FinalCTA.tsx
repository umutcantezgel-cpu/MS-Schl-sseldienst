...
export default function FinalCTA({ className }: { className?: string }) {
  return (
    <section aria-labelledby="final-cta-heading" className={cn("w-full bg-[var(--color-red-500)] py-[var(--space-16)] lg:py-[var(--space-24)] overflow-hidden relative", className)}>
      ...
      <div className="container mx-auto px-[var(--space-6)] md:px-[var(--space-8)] max-w-4xl relative z-10 flex flex-col items-center text-center">
        ...
        <h2 id="final-cta-heading" className="typo-h2 text-white">
        ...
        <div className="flex flex-col items-center gap-[var(--space-6)] w-full max-w-md mx-auto">
          ...
          <HeartbeatCTA className="w-full">
            <a
              ...
              className="flex items-center justify-center gap-3 w-full h-[72px] bg-white text-[var(--color-red-500)] hover:bg-slate-50 text-[20px] font-black rounded-[var(--radius-16)] shadow-[var(--elevation-2)] hover:-translate-y-2 hover:shadow-[var(--elevation-3)] transition-all duration-300 ease-out"
            >
          ...
          <span className="text-[15px] text-white/80 font-medium mt-2">
            Kein Risiko — Festpreis vor Anfahrt — Kostenlos & unverbindlich — 24/7 Erreichbar
          </span>
        </div>
      </div>
    </section>
