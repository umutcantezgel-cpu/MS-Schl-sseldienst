...
<p>Herborn ist jedoch weit mehr als "nur" seine weltbekannte Altstadt. Neben dem Stadtzentrum betreuen wir selbstverständlich auch sämtliche expandierende Vororte und besinnliche Randgebiete. Egal, ob Sie in den Eigenheimsiedlungen von <span class="font-bold text-[color:var(--text-primary)]">Seelbach</span> und <span class="font-bold text-[color:var(--text-primary)]">Burg</span>, in den ländlicheren Gebieten von <span class="font-bold text-[color:var(--text-primary)]">Schönbach</span> und <span class="font-bold text-[color:var(--text-primary)]">Sinn</span> (angrenzend), oder drüben in <span class="font-bold text-[color:var(--text-primary)]">Merkenbach</span> und <span class="font-bold text-[color:var(--text-primary)]">Uckersdorf</span> schnelle Hilfe benötigen und unser Schlüsseldienst garantiert für das gesamte Stadtgebiet von Herborn denselben Festpreis. Ohne Ausnahme.</p>
...
`,
    ...
    },
    {
        ...
        scenarios: [
            {
                ...
                description: "Viel Wind an den Oberschelder Hängen? Eine zugefallene Haustür öffnen wir in nahezu allen Fällen völlig ohne Beschädigung an Rahmen oder Zylinder."
            },
            {
                icon: "shield-check",
        ...
        aboutText: `
<p>Die stolze <span class="font-bold text-[color:var(--text-primary)]">Oranierstadt Dillenburg</span> erstreckt sich malerisch rund um das weithin sichtbare historische Juwel der Region und den majestätischen Wilhelmsturm. Als zentraler Verwaltungssitz im nördlichen Lahn-Dill-Kreis und Zuhause von etwa 23.500 Einwohnern bietet Dillenburg eine reizvolle, aber auch architektonisch anspruchsvolle Mischung: Ein prächtiger historischer Kern trifft hier auf aufstrebende, moderne Ortsteile wie <span class="font-bold text-[color:var(--text-primary)]">Oberscheld, Niederscheld, Donsbach, Nanzenbach, Eibach, Manderbach und Frohnhausen</span>. Genau diese Vielfalt an Türtypen und Sicherheitssystemen erfordert einen Schlüsseldienst, der nicht nur schnell, sondern mit größter handwerklicher Präzision arbeitet.</p>

<h3>Zerstörungsfreie Öffnung in der Dillenburger Altstadt</h3>
<p>Wenn die jahrhundertealte Holztür eines Fachwerkhauses am Fuße des Schlossberges oder nahe dem Kassierer Tor ungewollt ins Schloss fällt, zählen zwei Dinge: Ruhen bewahren und Profis rufen. Historisch wertvolle Türbeschläge und massive Holzstrukturen behandeln unsere erfahrenen Monteure wie rohe Eier. Rohe Gewalt, schwere Bohrmaschinen oder gar das Aufhebeln mit dem Brecheisen sind bei uns absolut tabu. Durch den Einsatz extrem filigraner Spezialwerkzeuge (Lockpicking, Luftkissen, Fallengleiter) liegt unsere Erfolgschance auf spurlos und völlig abrissfreie Entriegelung einer lediglich zugefallenen Tür bei nahezu allen Fällen. Sie sparen sich ruinierte Türblätter und extrem teure Tischlerreparaturen.</p>

<h3>A45-Express: Schnelle Reaktionszeit für ganz Dillenburg</h3>
<p>Wer seine Tür am nördlichen 30-km-Rand des Kreises hastig zuzieht, fühlt sich oft von schnellen städtischen Hilfsdiensten abgeschnitten. Doch keine Sorge: Durch die unschlagbar direkte Streckenführung der Autobahn A45 (Sauerlandlinie) befahren unsere Techniker die Distanz zwischen Wetzlar und Dillenburg weitaus rasanter als mancher lokale Regionalbetrieb. Zumeist dringen wir von unserer Alarmzentrale in hervorragenden <span class="font-bold text-[color:var(--text-primary)]">25 bis 30 Minuten</span> direkt bis vor Ihre Haustür vor. Keine Callcenter-Warteschleifen, sondern reibungslose Tourenplanung von Fachleuten.</p>
...
<p>Ehrliche Handwerksarbeit muss transparent sein. Transparenz bedeutet bei uns am nördlichsten Einsatzrand: Für die klassische Standardöffnung einer zugefallenen Tür erheben wir an ganz normalen Werktagen unseren strikten <span class="font-bold text-[color:var(--text-primary)]">99 Euro Fixbetrag</span>. Hinzu kommt eine äußerst knapp kalkulierte und vorher klar kommunizierte Autobahn-Routenpauschale von 20 Euro. Kein unübersichtlicher Kostenvoranschlag im Nachhinein, keine künstlichen Stundenabrechnungen. Wenn Sie die 06441-Nummer wählen, starten wir den Wagen nach Dillenburg noch, während wir telefonieren.</p>
`,
