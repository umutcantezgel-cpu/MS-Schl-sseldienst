...
export const ring3LocationsB: LocationData[] = [
    // --- RING 3 (10-20 km) Teil 2 ---
    {
        ...
        seo: {
            ...
            metaDescription: "Schlüsseldienst Biebertal: Zerstörungsfreie Türöffnung ab 99€. In ca. 12-15 Min. in Rodheim-Bieber, Fellingshausen, Vetzberg & allen 6 Ortsteilen. 06441-8056544",
        },
        ...
        parkingInfo: "In allen Biebertaler Ortsteilen parken unsere Einsatzfahrzeuge direkt vor dem Gebäude – die ländlich-suburban geprägte Gemeinde bietet überall ausreichend Platz.",
        heroVariant: "Schlüsseldienst für Biebertal – vom Keltenberg bis zum Gleiberger Land.",
        fareInfo: "Biebertal liegt im mittleren Ring unseres Einsatzgebiets. Die Anfahrt beträgt faire 15 Euro – identisch für alle sechs Ortsteile.",
...
<p>Für eine zugefallene Tür berechnen wir werktags tagsüber <strong>fix 99 Euro</strong>. Die Anfahrt nach Biebertal kostet <strong>15 Euro</strong> – pauschal für alle sechs Ortsteile. Sie erfahren den Gesamtpreis am Telefon, bevor unser Monteur losfährt. Ehrliches Handwerk für ehrliche Nachbarn im Gleiberger Land.</p>
`,
        ...
        localTestimonials: [
            ...
            {
                name: "Monika K.",
                quote: "Nach einer Wanderung am Dünsberg den Schlüssel verloren. Der Notdienst hat in Fellingshausen schnell reagiert, Zylindertausch war nötig – wurde transparent kommuniziert und fair abgerechnet.",
                rating: 5
            }
        ],

        content: {
            heroIntro: "Dringende Türöffnung in Biebertal? Unsere regionalen Techniker öffnen in Rodheim-Bieber, Fellingshausen und allen 6 Ortsteilen – blitzschnell, spurlos, zu 100% transparenten Festpreisen.",
            mainText: "",
        ...
        faqs: [
            {
                ...
                answer: "Selbstverständlich. Die 15 Euro Anfahrt gelten pauschal für alle sechs Biebertaler Ortsteile – von Rodheim-Bieber über Fellingshausen bis hinauf nach Königsberg. Keine Höhenzuschläge."
            },
            {
                question: "Können Sie historische Schlösser in den alten Hofanlagen öffnen?",
                answer: "Ja, unsere Techniker sind im Umgang mit antiken Kastenschlössern und historischen Beschlägen bestens geschult. Ob Fachwerktür oder moderne Sicherheitstür – wir arbeiten stets materialschonend."
            },
            {
                question: "Bieten Sie auch Einbruchschadensanierung in Biebertal an?",
                answer: "Ja, nach Einbruchsversuchen bauen wir beschädigte Schlösser aus und installieren aufbruchsichere Sicherheitszylinder und Schutzbeschläge – direkt aus unserem Einsatzfahrzeug."
            }
        ],
    ...
    },
    {
        ...
        seo: {
            ...
            metaDescription: "Schlüsseldienst Leun: Zerstörungsfreie Türöffnung ab 99€. In ca. 12-15 Min. in Biskirchen, Stockhausen, Bissenberg & Kernstadt. Faire Preise. 06441-8056544",
        },
        ...
        parkingInfo: "In allen vier Leuner Ortsteilen und im historischen Kern parken unsere Einsatzwagen problemlos und unmittelbar am Einsatzort – kurze Wege zum Werkzeugkoffer garantiert.",
        heroVariant: "Schlüsseldienst für Leun – von der Altstadt bis Biskirchen & Stockhausen.",
        fareInfo: "Leun liegt im mittleren Ring unseres Einsatzgebiets. Die Anfahrt beträgt faire 15 Euro – identisch für alle vier Ortsteile von Biskirchen bis Stockhausen.",

        scenarios: [
            {
                icon: "home",
                title: "Zugefallene Haustür in der Altstadt",
                description: "Die schwere Holztür Ihres Fachwerkhauses in der Limburger Straße ist ins Schloss gefallen? Unsere Spezialisten öffnen historische Kastenschlösser und moderne Profilzylinder gleichermaßen behutsam – ohne Kratzer am wertvollen Rahmen."
            },
            {
                icon: "shield-alert",
                title: "Schlüssel verloren beim Lahnradweg",
                description: "Nach einer Radtour auf dem Lahnradweg oder einer Wanderung zur Dianaburg den Schlüsselbund vermisst? Wir kommen schnell, öffnen Ihre Tür und tauschen bei Bedarf den Zylinder sofort – damit kein Unbefugter Zutritt hat."
            },
            {
                icon: "briefcase",
        ...
        aboutText: `
<p>An der historischen Lahntalbahn zwischen Wetzlar und Weilburg gelegen, verströmt die <strong>Stadt Leun</strong> mit ihren rund 5.700 Einwohnern den unverwechselbaren Charme einer hessischen Fachwerkkleinstadt. Vier eigenständige Stadtteile – <strong>Biskirchen, Bissenberg, Stockhausen</strong> und die <strong>Kernstadt Leun</strong> (inklusive Lahnbahnhof) – bilden zusammen ein Gemeinwesen, das durch seinen liebevoll erhaltenen historischen Ortskern, die unmittelbare Nähe zur Lahn und eine aktive Vereinslandschaft besticht. Wenn in einer solch Stille ausstrahlenden Gemeinde plötzlich die Haustür ins Schloss fällt oder ein veralteter Zylinder den Geist aufgibt, brauchen die Bewohner einen <strong>Schlüsseldienst Leun</strong>, der genauso zuverlässig und ehrlich ist wie die Stadt selbst.</p>
...
`,
        ...
        localTestimonials: [
            {
                name: "Jürgen H.",
                quote: "In der Leuner Altstadt ausgesperrt, direkt beim Erkerhaus. Der Monteur kam in 13 Minuten und hatte die uralte Holztür in 30 Sekunden offen – ohne einen einzigen Kratzer. 114 Euro insgesamt, alles sauber auf der Rechnung. Top!",
                rating: 5
            },
            {
                name: "Claudia R.",
        ...
        faqs: [
            {
                ...
                answer: "Ja, absolut. Die 15 Euro Anfahrt gelten pauschal für das gesamte Stadtgebiet Leun – von der Kernstadt über Biskirchen und Stockhausen bis nach Bissenberg. Keine versteckten Aufschläge."
            },
            {
    ...
    },
    {
        ...
        seo: {
            ...
            metaDescription: "Schlüsseldienst Waldsolms: Türöffnung ab 99€ in Brandoberndorf, Griedelbach & allen 6 Ortsteilen. Lokaler Meisterbetrieb, 15-18 Min. Anfahrt. 06441-8056544",
        },
        ...
        mainRoad: "L3054",
        distanceKm: 15,
        character: "Idyllische Taunusgemeinde mit 5-Sterne-Golfclub, Panoramawanderweg und Koptisch-Orthodoxem Zentrum – ländliche Ruhe auf höchstem Niveau",
        ...
        parkingInfo: "Die weitläufig verstreuten Ortsteile bieten überall großzügige Parkmöglichkeiten direkt vor den Grundstücken – ländlicher geht es kaum.",
        heroVariant: "Schlüsseldienst für Waldsolms – von der Taunusperle bis zum Golfclub Attighof.",
        fareInfo: "Waldsolms liegt im erweiterten Nahbereich. Die Anfahrt beträgt faire 15 Euro – identisch für alle sechs Ortsteile, egal wie versteckt.",

        scenarios: [
            {
                icon: "home",
                title: "Eigenheim-Tür zugefallen",
                description: "Die hochwertige Sicherheitstür Ihres Waldsolmser Eigenheims hat sich hinter Ihnen geschlossen? Wir öffnen sie spurlos – ohne Schäden an Rahmen, Lackierung oder Zylinder."
            },
            {
                icon: "shield-alert",
        ...
        aboutText: `
<p>Malerisch im südlichen Lahn-Dill-Kreis am Rand des Taunus gelegen, verströmt die Gemeinde <strong>Waldsolms</strong> mit ihren rund 4.660 Einwohnern pure ländliche Idylle auf höchstem Niveau. Sechs eigenständige Ortsteile – <strong>Brandoberndorf</strong> (Verwaltungssitz, ca. 1.970 Einwohner), <strong>Griedelbach, Hasselborn, Kraftsolms, Kröffelbach und Weiperfelden</strong> – bilden eine Gemeinde im Naturpark Taunus, die sich durch ihre außergewöhnliche Kombination aus Natur, Sport und Kultur auszeichnet. Wenn in dieser stillen Umgebung die Haustür zufällt, ist unser <strong>Schlüsseldienst Waldsolms</strong> schnell zur Stelle.</p>

<h3>15 bis 18 Minuten über die L3054</h3>
<p>Unsere Monteure finden jeden der weitläufig verstreuten Ortsteile blind und erreichen Sie über die <strong>L3054</strong> in <strong>15 bis 18 Minuten</strong>. Ob am <strong>Lindenplatz in Brandoberndorf</strong> mit seiner evangelischen Kirche aus dem 17. Jahrhundert und dem historischen Schulhaus (heute Rathaus), im beschaulichen <strong>Griedelbach</strong> mit seiner Dorfkirche aus dem 15. Jahrhundert und der uralten Linde, oder im abgelegenen <strong>Weiperfelden</strong> – wir bringen städtische Professionalität in die ländliche Umgebung.</p>

<h3>Attighof Golfclub, Taunusperle & Panoramaweg</h3>
<p>Waldsolms überrascht mit erstklassiger Infrastruktur: Der <strong>Attighof Golf- und Countryclub</strong> – ein 5-Sterne-Golfclub mit 18-Loch-Platz auf 80 Hektar – lockt Golfer aus der ganzen Region. Das <strong>Freibad „Taunusperle"</strong> in Brandoberndorf ist im Sommer ein beliebter Treffpunkt für die gesamte Gemeinde. Der <strong>18,5 km lange „Panoramaweg Waldsolms"</strong> verbindet die Ortsteile auf einer Wanderstrecke mit atemberaubenden Taunuspanoramen. Und das <strong>Koptisch-Orthodoxe Zentrum mit dem St. Antonius-Kloster</strong> setzt einen besonderen kulturellen und spirituellen Akzent. Überall dort, wo Menschen aktiv sind und leben, gibt es gelegentlich Aussperrungen – und dafür gibt es uns.</p>
...
<p>Für eine zugefallene Tür berechnen wir werktags tagsüber <strong>fix 99 Euro</strong>. Die Anfahrt nach Waldsolms kostet <strong>15 Euro</strong> – pauschal für alle sechs Ortsteile. Ob Weiperfelden oder Brandoberndorf: Der Gesamtpreis steht, bevor unser Monteur losfährt.</p>
`,
        ...
        localTestimonials: [
            ...
            {
                name: "Gisela S.",
                quote: "Wir wohnen etwas abgelegen in Weiperfelden. Dass ein Schlüsseldienst so schnell hier sein kann, hat mich überrascht. Professionell, freundlich und transparent – genau wie am Telefon angekündigt.",
                rating: 5
            },
            {
                name: "Thomas L.",
    ...
    },
    {
        ...
        seo: {
            ...
            metaDescription: "Schlüsseldienst Butzbach: Zerstörungsfreie Türöffnung ab 99€. In ca. 20-25 Min. in der Friedrich-Ludwig-Weidig-Stadt & allen 14 Ortsteilen. 06441-8056544",
        },
        ...
        heroVariant: "Schlüsseldienst für Butzbach – die Perle der Wetterau verdient ehrliches Handwerk.",
        fareInfo: "Butzbach liegt im erweiterten Ring. Die Anfahrt beträgt faire 15 Euro – identisch für alle 14 Ortsteile, vom Marktplatz bis nach Maibach.",
...
`,
        ...
        content: {
            heroIntro: "Dringende Hilfe in der Perle der Wetterau? Wir öffnen Türen in Butzbach und allen 14 Ortsteilen – von der Fachwerk-Altstadt bis zum Neubaugebiet. Fair, transparent, 24/7.",
            mainText: "",
            serviceZerstörungsfrei: "",
            serviceBohren: "",
            service247: "",
        ...
        faqs: [
            {
                ...
                answer: "Ja, die 15 Euro Anfahrt gelten pauschal für alle 14 Butzbacher Ortsteile – von der Kernstadt über Nieder-Weisel und Ostheim bis nach Maibach und Münster. Keine Extrazuschläge."
            },
            {
