...
export const ring3LocationsB: LocationData[] = [
    // --- RING 3 (10-20 km) Teil 2 ---
    {
        ...
        aboutText: `
<p>Eingebettet in die reizvolle mittelhessische Landschaft am Fuße des <span class="font-bold text-[color:var(--text-primary)]">Dünsbergs</span> (497 m) liegt die Gemeinde <span class="font-bold text-[color:var(--text-primary)]">Biebertal</span> mit ihren rund 10.000 Einwohnern im Gleiberger Land. Sechs Ortsteile und <span class="font-bold text-[color:var(--text-primary)]">Rodheim-Bieber, Fellingshausen, Krumbach, Königsberg, Frankenbach und Vetzberg</span> und bilden eine Gemeinde, die durch ihre einzigartige Verbindung von Keltengeschichte, Naturerlebnis und ländlichem Wohnkomfort besticht. Wenn in dieser idyllischen Umgebung die Haustür ins Schloss fällt, ist unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Biebertal</span> schnell zur Stelle.</p>

<h3>12 bis 15 Minuten über die L3047</h3>
<p>Durch unsere zentrale Verortung im Nachbargebiet Wetzlar benötigen unsere Monteure über die <span class="font-bold text-[color:var(--text-primary)]">L3047</span> in der Regel lediglich <span class="font-bold text-[color:var(--text-primary)]">12 bis 15 Minuten</span> direkt an Ihre Tür. Ob im größten Ortsteil <span class="font-bold text-[color:var(--text-primary)]">Rodheim-Bieber</span> (ca. 5.150 Einwohner), in <span class="font-bold text-[color:var(--text-primary)]">Fellingshausen</span> am Dünsbergfuß, im beschaulichen <span class="font-bold text-[color:var(--text-primary)]">Krumbach</span> oder auf der Höhe von <span class="font-bold text-[color:var(--text-primary)]">Königsberg</span> und wir kennen jeden Weg und jede Abzweigung.</p>

<h3>Dünsberg, Keltenwelten & Gail'scher Park</h3>
<p>Biebertal ist ein kulturelles Juwel. Der <span class="font-bold text-[color:var(--text-primary)]">Dünsberg</span> mit seinen <span class="font-bold text-[color:var(--text-primary)]">keltischen Ringwallanlagen</span> und eine der letzten keltischen Siedlungsstätten nördlich des Mains und thront majestätisch über der Gemeinde. Der <span class="font-bold text-[color:var(--text-primary)]">Dünsbergturm</span> bietet spektakuläre Panoramablicke. Am Krumbacher Kreuz wurde ein <span class="font-bold text-[color:var(--text-primary)]">Keltengehöft rekonstruiert</span> mit Museum und Besucherinformationszentrum. Premium-Wanderwege wie der <span class="font-bold text-[color:var(--text-primary)]">„Kelten- und Römerpfad"</span> und der <span class="font-bold text-[color:var(--text-primary)]">„Celtic-Art-Weg"</span> locken Wanderer aus der gesamten Region. In <span class="font-bold text-[color:var(--text-primary)]">Rodheim-Bieber</span> begeistert der <span class="font-bold text-[color:var(--text-primary)]">Gail'sche Park</span> und ein englischer Landschaftspark mit über hundert Gehölzarten und und das <span class="font-bold text-[color:var(--text-primary)]">Bauernhausmuseum Hof Haina</span> gibt Einblicke in die bäuerliche Kultur Mittelhessens. Die malerische <span class="font-bold text-[color:var(--text-primary)]">Burgruine Vetzberg</span> rundet das kulturelle Angebot ab.</p>

<h3>6 Ortsteile, ein Versprechen</h3>
<p><span class="font-bold text-[color:var(--text-primary)]">Rodheim-Bieber</span> als größter Ortsteil und Verwaltungssitz bildet das Zentrum der Gemeinde mit dem <span class="font-bold text-[color:var(--text-primary)]">Heimatmuseum</span> im historischen Rathaus von 1892. <span class="font-bold text-[color:var(--text-primary)]">Fellingshausen, Krumbach, Königsberg, Frankenbach</span> und <span class="font-bold text-[color:var(--text-primary)]">Vetzberg</span> vervollständigen das weitläufige Gemeindegebiet. Für alle sechs Ortsteile gilt: identische Anfahrtskosten, identische Reaktionszeit, identische handwerkliche Qualität.</p>

<h3>24/7 Notdienst an 365 Tagen</h3>
<p>Ob nach einer Abendwanderung auf dem Dünsberg, am Sonntagmorgen in Frankenbach oder mitten in der Nacht in Vetzberg: Unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsselnotdienst Biebertal</span> ist rund um die Uhr einsatzbereit. Wir lassen Sie niemals draußen stehen.</p>

<h3>Transparent wie das Gleiberger Land</h3>
<p>Für eine zugefallene Tür berechnen wir werktags tagsüber <span class="font-bold text-[color:var(--text-primary)]">fix 99 Euro</span>. Die Anfahrt nach Biebertal kostet <span class="font-bold text-[color:var(--text-primary)]">15 Euro</span> und pauschal für alle sechs Ortsteile. Sie erfahren den Gesamtpreis am Telefon, bevor unser Monteur losfährt. Ehrliches Handwerk für ehrliche Nachbarn im Gleiberger Land.</p>
`,
    ...
    },
    {
        ...
        aboutText: `
<p>An der historischen Lahntalbahn zwischen Wetzlar und Weilburg gelegen, verströmt die <span class="font-bold text-[color:var(--text-primary)]">Stadt Leun</span> mit ihren rund 5.700 Einwohnern den unverwechselbaren Charme einer hessischen Fachwerkkleinstadt. Vier eigenständige Stadtteile und <span class="font-bold text-[color:var(--text-primary)]">Biskirchen, Bissenberg, Stockhausen</span> und die <span class="font-bold text-[color:var(--text-primary)]">Kernstadt Leun</span> (inklusive Lahnbahnhof) und bilden zusammen ein Gemeinwesen, das durch seinen liebevoll erhaltenen historischen Ortskern, die unmittelbare Nähe zur Lahn und eine aktive Vereinslandschaft besticht. Wenn in einer solch Stille ausstrahlenden Gemeinde plötzlich die Haustür ins Schloss fällt oder ein veralteter Zylinder den Geist aufgibt, brauchen die Bewohner einen <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Leun</span>, der genauso zuverlässig und ehrlich ist wie die Stadt selbst.</p>

<h3>Durch das Lahntal in 12 Minuten bei Ihnen</h3>
<p>Die <span class="font-bold text-[color:var(--text-primary)]">B49</span>, die sich als Lebensader parallel zur Lahn durchs Tal schlängelt, ist für unsere Einsatzfahrten die perfekte Verbindung. Von unserer Wetzlarer Basis aus erreichen wir über diese Strecke sowohl die Leuner Kernstadt als auch die etwas abgelegeneren Ortsteile Stockhausen und Bissenberg in verlässlichen <span class="font-bold text-[color:var(--text-primary)]">12 bis 15 Minuten</span>. Diese Schnelligkeit ist kein leeres Versprechen, sondern tägliche Praxis: Wir kennen jeden Kreisverkehr, jede Ampelphase und jede Abkürzung im Lahntal. Wenn Sie frierend vor Ihrer verschlossenen Haustür stehen, zählt jede einzelne Minute.</p>

<h3>Fachwerk, Erkerhaus & historische Schlösser</h3>
<p>Was Leun architektonisch so besonders macht, ist der bemerkenswert gut erhaltene <span class="font-bold text-[color:var(--text-primary)]">historische Stadtkern</span>. Die <span class="font-bold text-[color:var(--text-primary)]">Limburger Straße</span> mit ihren malerischen Fachwerkhäusern aus dem 17. Jahrhundert, das stadtbekannte <span class="font-bold text-[color:var(--text-primary)]">Erkerhaus</span> als Wahrzeichen und das barocke Hofportal des ehemaligen Junkerhofs zeugen von jahrhundertelanger Bautradition. Für unsere Techniker bedeutet das: Wir treffen hier auf eine enorme Bandbreite an Schlössern und Türkonstruktionen und von antiken Kastenschlössern an schweren Eichenholztüren bis hin zu modernen Mehrfachverriegelungen in neueren Siedlungen am Stadtrand. Unser Versprechen bleibt dabei immer dasselbe: maximale Schonung, minimaler Eingriff. Bei zugefallenen Türen liegt unsere zerstörungsfreie Öffnungsrate bei nahezu allen.</p>

<h3>Biskirchen, Stockhausen & Bissenberg: Jeder Ortsteil gleich schnell</h3>
<p>In <span class="font-bold text-[color:var(--text-primary)]">Biskirchen</span>, dem zweitgrößten Stadtteil mit gut 1.500 Einwohnern, finden sich neben der sehenswerten Kirche auch zahlreiche gut erhaltene historische Höfe wie „Heebs Hof" mit typischem Fachwerk aus dem 19. Jahrhundert. <span class="font-bold text-[color:var(--text-primary)]">Stockhausen</span> ist durch den <span class="font-bold text-[color:var(--text-primary)]">Bahnhof an der Lahntalbahn</span> ein beliebter Ausgangspunkt für Wanderungen in den Hessischen Westerwald und und genau dort, wo Outdoor-Enthusiasten unterwegs sind, gehen gelegentlich Schlüssel verloren. Das ländliche <span class="font-bold text-[color:var(--text-primary)]">Bissenberg</span> mit seinen rund 730 Einwohnern zeichnet sich durch Eigenheime inmitten grüner Natur aus. Für alle vier Ortsteile gilt: identische Anfahrtskosten, identische Reaktionszeit, identische Qualität.</p>

<h3>Evangelische Kirche, Stadtmuseum & Dianaburg</h3>
<p>Die <span class="font-bold text-[color:var(--text-primary)]">Evangelische Kirche</span> mit ihrem gotischen Westturm aus dem 14. Jahrhundert, der wertvollen Bürgy-Orgel und dem mittelalterlichen Kirchenschiff ist das spirituelle Herz der Stadt. Das <span class="font-bold text-[color:var(--text-primary)]">Stadtmuseum</span> im ehemaligen Rathaus von 1818 bewahrt die lokale Geschichte, und die <span class="font-bold text-[color:var(--text-primary)]">Dianaburg</span> und ein ehemaliges Jagdschloss nahe dem Kesselberg und lockt Wanderer aus der gesamten Region. In einer Gemeinde, die ihre Geschichte so sorgfältig pflegt, passen wir als traditionsbewusster, ehrlicher Handwerksbetrieb perfekt hinein.</p>

<h3>24/7 Notdienst im gesamten Stadtgebiet</h3>
<p>Ob mitten in der Nacht im Fachwerkhaus der Altstadt, am frühen Morgen vor dem Pendlerzug in Stockhausen oder an einem Feiertag in Biskirchen: Unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsselnotdienst Leun</span> operiert lückenlos an 365 Tagen im Jahr. Wir lassen Sie niemals im Stich und auch nicht bei Schneefall, Starkregen oder in den abgelegensten Ecken von Bissenberg.</p>

<h3>Transparente Preise für die gesamte Stadt</h3>
<p>Unsere Kalkulation ist so durchsichtig wie das Lahnwasser an einem Sommertag: Für eine einfache zugefallene Tür berechnen wir werktags tagsüber <span class="font-bold text-[color:var(--text-primary)]">fix 99 Euro</span>. Die Anfahrt nach Leun (alle Ortsteile eingeschlossen) kostet faire <span class="font-bold text-[color:var(--text-primary)]">15 Euro</span>. Das erfahren Sie am Telefon, bevor sich unser Monteur überhaupt auf den Weg macht. Keine versteckten Zuschläge, keine erfundenen Materialkosten, keine bösen Überraschungen auf der Rechnung.</p>
`,
    ...
    },
    {
        ...
        aboutText: `
<p>Malerisch im südlichen Lahn-Dill-Kreis am Rand des Taunus gelegen, verströmt die Gemeinde <span class="font-bold text-[color:var(--text-primary)]">Waldsolms</span> mit ihren rund 4.660 Einwohnern pure ländliche Idylle auf höchstem Niveau. Sechs eigenständige Ortsteile und <span class="font-bold text-[color:var(--text-primary)]">Brandoberndorf</span> (Verwaltungssitz, ca. 1.970 Einwohner), <span class="font-bold text-[color:var(--text-primary)]">Griedelbach, Hasselborn, Kraftsolms, Kröffelbach und Weiperfelden</span> und bilden eine Gemeinde im Naturpark Taunus, die sich durch ihre außergewöhnliche Kombination aus Natur, Sport und Kultur auszeichnet. Wenn in dieser stillen Umgebung die Haustür zufällt, ist unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Waldsolms</span> schnell zur Stelle.</p>

<h3>15 bis 18 Minuten über die L3054</h3>
<p>Unsere Monteure finden jeden der weitläufig verstreuten Ortsteile blind und erreichen Sie über die <span class="font-bold text-[color:var(--text-primary)]">L3054</span> in <span class="font-bold text-[color:var(--text-primary)]">15 bis 18 Minuten</span>. Ob am <span class="font-bold text-[color:var(--text-primary)]">Lindenplatz in Brandoberndorf</span> mit seiner evangelischen Kirche aus dem 17. Jahrhundert und dem historischen Schulhaus (heute Rathaus), im beschaulichen <span class="font-bold text-[color:var(--text-primary)]">Griedelbach</span> mit seiner Dorfkirche aus dem 15. Jahrhundert und der uralten Linde, oder im abgelegenen <span class="font-bold text-[color:var(--text-primary)]">Weiperfelden</span> und wir bringen städtische Professionalität in die ländliche Umgebung.</p>

<h3>Attighof Golfclub, Taunusperle & Panoramaweg</h3>
<p>Waldsolms überrascht mit erstklassiger Infrastruktur: Der Attighof Golf- und Countryclub und ein 5-Sterne-Golfclub mit 18-Loch-Platz auf 80 Hektar und lockt Golfer aus der ganzen Region. Das Freibad "Taunusperle" in Brandoberndorf ist im Sommer ein beliebter Treffpunkt für die gesamte Gemeinde. Der 18,5 km lange "Panoramaweg Waldsolms" verbindet die Ortsteile auf einer Wanderstrecke mit atemberaubenden Taunuspanoramen. Und das Koptisch-Orthodoxe Zentrum mit dem St. Antonius-Kloster setzt einen besonderen kulturellen und spirituellen Akzent. Überall dort, wo Menschen aktiv sind und leben, gibt es gelegentlich Aussperrungen und und dafür gibt es uns.</p>

<h3>6 Ortsteile, ein Versprechen</h3>
<p><span class="font-bold text-[color:var(--text-primary)]">Brandoberndorf</span> als Verwaltungssitz mit Lindenplatz, neuestem Bike Park mit Pumptrack (eröffnet 2024) und dem Freibad bildet das Zentrum. <span class="font-bold text-[color:var(--text-primary)]">Griedelbach</span> (ca. 700 Einwohner) begeistert mit seiner historischen Dorfkirche und den keltischen Hügelgräbern in der Umgebung. <span class="font-bold text-[color:var(--text-primary)]">Hasselborn, Kraftsolms, Kröffelbach</span> und <span class="font-bold text-[color:var(--text-primary)]">Weiperfelden</span> vervollständigen das Gemeindegebiet. Für alle sechs gilt: identische Anfahrtskosten, identische Reaktionszeit, identische Qualität.</p>

<h3>Transparente Festpreise für die Taunusgemeinde</h3>
<p>Für eine zugefallene Tür berechnen wir werktags tagsüber <span class="font-bold text-[color:var(--text-primary)]">fix 99 Euro</span>. Die Anfahrt nach Waldsolms kostet <span class="font-bold text-[color:var(--text-primary)]">15 Euro</span> und pauschal für alle sechs Ortsteile. Ob Weiperfelden oder Brandoberndorf: Der Gesamtpreis steht, bevor unser Monteur losfährt.</p>
`,
    ...
    },
    {
        ...
        aboutText: `
<p>Mit stolzen rund <span class="font-bold text-[color:var(--text-primary)]">27.000 Einwohnern</span> und <span class="font-bold text-[color:var(--text-primary)]">14 eigenständigen Ortsteilen</span> ist <span class="font-bold text-[color:var(--text-primary)]">Butzbach</span> die bedeutende Mittelstadt am Tor zwischen Wetterau und Taunus. Seit 2011 trägt sie den offiziellen Beinamen <span class="font-bold text-[color:var(--text-primary)]">„Friedrich-Ludwig-Weidig-Stadt"</span> und in Ehrung des Vormärz-Revolutionärs, der hier als Lehrer wirkte und als Vorkämpfer der deutschen Demokratiebewegung in die Geschichte einging. Die preisgekrönte <span class="font-bold text-[color:var(--text-primary)]">Fachwerk-Altstadt</span> rund um den historischen Marktplatz zählt zu den schönsten in ganz Hessen und liegt an der <span class="font-bold text-[color:var(--text-primary)]">Deutschen Fachwerkstraße</span>. Für unseren <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Butzbach</span> bedeutet diese Vielfalt: Jeder Einsatz ist einzigartig.</p>

<h3>20 bis 25 Minuten über A5 und B3</h3>
<p>Dank der fantastischen Verkehrsanbindung über die <span class="font-bold text-[color:var(--text-primary)]">A5 (Abfahrt Gambacher Kreuz)</span> und die <span class="font-bold text-[color:var(--text-primary)]">B3</span> rücken unsere ausgebildeten Techniker in <span class="font-bold text-[color:var(--text-primary)]">20 bis 25 Minuten</span> nach Butzbach aus. Das gilt für die Kernstadt ebenso wie für die äußersten Ortsteile <span class="font-bold text-[color:var(--text-primary)]">Maibach, Münster, Bodenrod</span> oder <span class="font-bold text-[color:var(--text-primary)]">Hausen-Oes</span>. Wenn Sie nach dem Telefonat auflegen, ist unser Monteur bereits auf dem direkten Weg zu Ihrer Postleitzahl.</p>

<h3>Solmser Schloss, Stadtmuseum & Miniaturschuh-Sammlung</h3>
<p>Butzbach ist ein kulturgeschichtliches Juwel: Das <span class="font-bold text-[color:var(--text-primary)]">Solmser Schloss</span> erhebt sich majestätisch über der Stadt, die <span class="font-bold text-[color:var(--text-primary)]">Stadtmauer aus dem 14./15. Jahrhundert</span> umschließt das historische Zentrum. Das <span class="font-bold text-[color:var(--text-primary)]">Museum der Stadt Butzbach</span> im ehemaligen Solms-Braunfelser Hof präsentiert 2.000 Jahre Lokalgeschichte und vom Römerlager bis zur Gegenwart und und beherbergt eine <span class="font-bold text-[color:var(--text-primary)]">weltberühmte Sammlung von Miniaturschuhen</span>. Der <span class="font-bold text-[color:var(--text-primary)]">Römische Turm am Schrenzerberg</span> erinnert an den Obergermanisch-Raetischen Limes. In <span class="font-bold text-[color:var(--text-primary)]">Nieder-Weisel</span> (ca. 3.400 Einwohner), dem größten Ortsteil, steht die historische <span class="font-bold text-[color:var(--text-primary)]">Komturkirche</span> und ein seltenes Zeugnis der Johanniter-Ordenstradition.</p>

<h3>14 Ortsteile und ein einheitlicher Festpreis</h3>
<p>Butzbach besteht aus <span class="font-bold text-[color:var(--text-primary)]">Bodenrod, der Kernstadt, Ebersgöns, Fauerbach vor der Höhe, Griedel, Hausen-Oes, Hoch-Weisel, Kirch-Göns, Maibach, Münster, Nieder-Weisel, Ostheim, Pohl-Göns</span> und <span class="font-bold text-[color:var(--text-primary)]">Wiesental</span>. Von der antiken Fachwerktür am Marktplatz bis zur modernen Sicherheitstür im Neubaugebiet Ostheim: Unsere Techniker bewältigen jede Herausforderung. Für alle 14 Ortsteile gilt: identische Anfahrtskosten, identische Reaktionszeit, identische Qualität.</p>

<h3>24/7 Notdienst für die Friedrich-Ludwig-Weidig-Stadt</h3>
<p>Butzbach lebt und pulsiert: Wochenmarkt, Kulturveranstaltungen im Solmser Schloss, Vereinsleben in den Ortsteilen. Wo Leben ist, passieren Aussperrungen. Unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsselnotdienst Butzbach</span> ist deshalb rund um die Uhr einsatzbereit und an Feiertagen, bei Wetterau-Karneval und auch an einem nasskalten Februartag.</p>

<h3>Transparente Festpreise</h3>
<p>Für eine zugefallene Tür berechnen wir werktags tagsüber <span class="font-bold text-[color:var(--text-primary)]">fix 99 Euro</span>. Die Anfahrt nach Butzbach kostet <span class="font-bold text-[color:var(--text-primary)]">15 Euro</span> und pauschal für alle 14 Ortsteile. In einer Stadt, die den Kampf für Gerechtigkeit in ihrem Namen trägt, passen wir als ehrlicher und transparenter Fachbetrieb bestens hinein.</p>
`,
