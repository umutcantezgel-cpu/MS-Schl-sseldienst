...
export const ring3fLocations: LocationData[] = [
    // ━━━━ BIEBERTAL und 6 ORTSTEILE ━━━━
    {
        ...
        aboutText: `
<p>Dort, wo der Dünsberg majestätisch über die Region wacht, liegt <span class="font-bold text-[color:var(--text-primary)]">Fellingshausen</span> als ruhiger Ortsteil der Gemeinde Biebertal. Naturnahes Wohnen und familiäre Nachbarschaften prägen das Bild. Wer nach einem ausgiebigen Waldspaziergang jedoch vor einer unerbittlich verschlossenen Haustür steht, weil der Schlüsselbund im Flur liegt, braucht einen Handwerker, der das Idyll nicht mit Wucherpreisen zerstört. Als echter Experte aus der Region Wetzlar ist der <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Fellingshausen</span> an Ihrer Seite.</p>

<h3>Flotte Dünsberg-Routen</h3>
<p>Unsere Leitstelle dirigiert die Monteure zielführend über die L3286 oder Wettenberg direkt in den Ortskern von Fellingshausen. Das resultiert in einer rekordverdächtigen Durchschnitts-Ankunftszeit von <span class="font-bold text-[color:var(--text-primary)]">14 Minuten</span> ab Alarmierung. So müssen Sie an herbstlichen Waldabenden nicht zitternd vor dem eigenen Haus ausharren.</p>
...
<p>Dubiose Vermittler aus fernen Großstädten berechnen für Waldranddörfer gerne absurde Kilometergelder. Bei uns existiert das nicht: Das Öffnen einer lediglich ins Schloss gefallenen Standard-Eingangstür berechnen wir werktags tagsüber ab verbindlichen 99 Euro. Hinzu gesellt sich lediglich eine exakte Reisepauschale von 15 Euro für den Einsatzwagen. Nichts weiter. Ehrliches, mittelhessisches Handwerk.</p>`,
        ...
        content: {
            ...
            mainText: `<p>Die Waldrand-Lage von <span class="font-bold text-[color:var(--text-primary)]">Fellingshausen</span> schreckt uns keinesfalls ab und im Gegenteil: Unser Aufsperrdienst agiert hier mit lokaler Leidenschaft und rasanter Fahrzeit.</p>`,
    ...
    },
    {
        ...
        aboutText: `
<p>Eingebettet in die mittelhessischen Hangwälder der Gemeinde Biebertal findet sich das beschaulich-ruhige <span class="font-bold text-[color:var(--text-primary)]">Frankenbach</span>. Ländliche Idylle und traditionelles Wohnen in alten Höfen und Eigenheimen garantieren hier eine tiefe Lebensqualität. Steckt der Wohnungsschlüssel jedoch am Samstagabend ausgerechnet von innen und die Haustür ist eiskalt zugefallen, wird diese Ruhe jäh gestört. Glücklicherweise fungiert der <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Frankenbach</span> als flinker Nachbarschafts-Helfer aus dem Wetzlarer Verbund.</p>

<h3>In flotten 15 Minuten gelöst</h3>
<p>Die etwas tiefer ins Biebertal reichende Landstraße hindert unsere Einsätzkräfte nicht daran, den Turbo einzuschalten. Über sichere, direkte Anfahrtswege meistern wir die Distanz im Normalfall in sehr verlässlichen <span class="font-bold text-[color:var(--text-primary)]">15 Minuten</span>. Sie bleiben somit nicht lange Regen, Wind oder der drückenden Hitze preisgegeben.</p>
...
<p>Für ländliche Regionen existieren leider oft schwarze Schafe auf dem Schlossermarkt, die absurde Zufuhrkosten in Rechnung stellen. Nicht mit uns: Wir deklarieren unser 99-Euro-Paket (für Standard-Werktags-Öffnungen von lediglich zugefallenen Türen) als absolutes Heiligtum. Da Frankenbach eine gewisse Fahrzeit erfordert, erheben wir schlichte 15 Euro PKW-Pauschale. Dieses transparente Konstrukt garantieren wir Ihnen bereits unverbindlich beim ersten Call.</p>`,
        ...
        content: {
            ...
            mainText: `<p>Tief in der Struktur von <span class="font-bold text-[color:var(--text-primary)]">Frankenbach</span> angesiedelte Problemfälle meistert unser lokaler Aufsperrdienst Wetzlar extrem zeitnah und materialschonend.</p>`,
    ...
    },
    {
        ...
        aboutText: `
<p>Hoch oben über der Gemeinde Biebertal, idyllisch umgeben von ausgedehnten Waldgebieten und historischen Ruinen-Spots, liegt <span class="font-bold text-[color:var(--text-primary)]">Königsberg</span>. Aus dem beschaulichen Wohnort am Hang eröffnet sich ein toller Mittelhessen-Blick. Ungemütlich wird diese Höhenlage aber sofort, wenn im winterlichen Schneetreiben oder einer kräftigen Herbstböe die eigene Haustür hinter einem zufällt. Steckt der Schlüssel von innen, hilft kein Zittern, sondern nur der Griff zum Handy. Der regional verankerte <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Königsberg</span> steuert Ihren Berg zügig aus dem Wetzlarer Talkessel an.</p>

<h3>Rasante Bergfahrt aus dem Zentrum</h3>
<p>Unsere Wetzlar-Basis ist der Schlüssel (im wahrsten Sinne) zu einer reaktionsschnellen Logistik. Wenn wir das Signal für Königsberg erhalten, navigieren unsere routinierten Techniker sicher über die L3286 nach oben. Meist stellen wir nach bloß <span class="font-bold text-[color:var(--text-primary)]">16 Minuten</span> den Motor auf Ihrem Hof ab und echte Regionalkraft statt überregionale Disponenten.</p>
...
<p>Die Berg-Dörfer des Biebertals bestrafen wir nicht mit ausfallenden Überland-Fahrpreisen. Bei glattflächig zugezogenen Wohnungstüren garantieren wir am Werktag tagsüber vollkommene 99 Euro Festpreis. Dazu runden winzige 15 Euro Fahrpauschale unsere Rechnung transparent ab. Bevor wir zerspanende Bohrer an verriegelten Altbau-Türen einsetzen, werden Sie exakt und ehrlich über Machbarkeit und Folgekosten (inkl. neuem Qualitäts-Zylinder) informiert.</p>`,
        ...
        content: {
            ...
            mainText: `<p>Die besondere Höhenlage von <span class="font-bold text-[color:var(--text-primary)]">Königsberg</span> meistern unsere Monteure anstandslos und und das zu bodenständigen Wetzlar-Dorfpreisen.</p>`,
    ...
    },
    {
        ...
        aboutText: `
<p>Versteckt im üppigen Grün der Natur, thront <span class="font-bold text-[color:var(--text-primary)]">Krumbach</span> als weitaus kleinster und isoliertester Ortsteil der Gemeinde Biebertal in Mittelhessen. Die absolute ländliche Ruhe fernab jeder Autobahn ist ein Privileg und bis zu jenem frustrierenden Moment, in dem die betagte Haustür plötzlich im Wind in die Schlossfalle kracht. Den Haustürschlüssel von außen vergessen? Kein regionales Service-Auto in Sicht? Der renommierte und ortsnahe <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Krumbach</span> (operierend als Schluessel-Schmiede Wetzlar) lässt Anrufer aus solch abgelegenen Dörfern glücklicherweise nie im Stich.</p>

<h3>Zügige Navigation ans Ende des Tals</h3>
<p>Ein faires Versprechen: Unsere Dienstleistungs-Geschwindigkeit sinkt auch bei Weiler-Dörfern nicht. Durch unser profundes Ortswissen um Wetzlar und Biebertal schlängeln wir uns meist in rekordnahen <span class="font-bold text-[color:var(--text-primary)]">17 Minuten</span> nach Krumbach. Echte lokale Techniker und kein frustrierendes Warten auf Handwerker aus dem 50 Kilometer entfernten Gießen.</p>
...
<p>Wir erteilen überzogenen "Fernfahrt-Zuschlägen" feierlich eine Absage. Egal, wie tief gelegen Krumbach sein mag: Öffnen wir eine simplere, zugezogene Haus- oder Wohnungstür, geschieht dies am Tag zielsicher für 99 Euro. Hinzu berechnen wir nur hauchdünne 15 Euro Einsatzwagen-Kosten. Verriegelte Türen zwingen zuweilen zum Fräsen (Zylinder geht dabei verloren) und diese Kosten strukturieren wir vorab so glasklar, dass nach der Arbeit garantiert kein Streit um die Rechnung ausbricht.</p>`,
        ...
        content: {
            ...
            mainText: `<p>Selbst den kleinsten Ortsteil <span class="font-bold text-[color:var(--text-primary)]">Krumbach</span> vernetzen wir vollwertig in unserem rasanten Wetzlarer Einsatzgebiet.</p>`,
    ...
    },
    {
        ...
        aboutText: `
<p>Das Herzstück und Verwaltungszentrum der Gemeinde Biebertal bildet zweifelsohne <span class="font-bold text-[color:var(--text-primary)]">Rodheim-Bieber</span>. Mit regem Gewerbe, Supermärkten, Ärzten und großen Mehrfamilienhäusern pulsiert hier das Leben. Ein verlorener Büroschlüssel oder ein im Treppenhaus vergessener Wohnungsschlüssel führt in diesem regen Umfeld schnell zu nervenaufreibenden Situationen. Bevor Hektik ausbricht, greift unser aus dem nahen Wetzlar operierender <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Rodheim-Bieber</span> sicher und professionell ein.</p>

<h3>Zentral gelegen, flink erreicht</h3>
<p>Weil Rodheim-Bieber infrastrukturell über die Landstraße L3286 und die Gießener Straße exzellent vernetzt ist, gehören strapaziöse Wartezeiten der Vergangenheit an. Sind unsere Notdienst-Monteure erst alarmiert, biegen sie im Schnitt nach nur <span class="font-bold text-[color:var(--text-primary)]">13 Minuten Fahrzeit</span> in Ihre Straße ein. Wir beenden Ihre Schieflage, egal ob im belebten Ortskern oder in peripheren Wohnsiedlungen.</p>
...
<p>In dicht besiedelten Gebieten locken schwarze Schafe der Branche gerne mit "ab 15 Euro"-Fallen. Wir begegnen diesen Praktiken mit eiserner Transparenz. Ein Standardauftrag (zugefallene Haus- oder Wohnungstür, ungeöffnet) am helllichten Werktag kostet vertraglich zugesicherte 99 Euro Festpreis. Dazu kommen 15 Euro Mobilitätspauschale nach Biebertal. Unsere kompetenten Monteure bohren erst und nur in letzter Instanz, falls jedes zerstörungsfreie Spezialwerkzeug am hochkomplexen Schließzylinder scheitern sollte und und dann ausschließlich in Rücksprache mit Ihren Wünschen.</p>`,
        ...
        content: {
            ...
            mainText: `<p>Ob Praxiseingang oder Privatwohnung und in <span class="font-bold text-[color:var(--text-primary)]">Rodheim-Bieber</span> liefern wir blitzschnelle, verlässliche Handwerksqualität direkt aus Wetzlar.</p>`,
    ...
    },
    {
        ...
        aboutText: `
<p>Im eindrucksvollen Schatten der gleichnamigen Burgruine erstreckt sich das malerische <span class="font-bold text-[color:var(--text-primary)]">Vetzberg</span> als historisches Juwel der Gemeinde Biebertal. Enge Gassen, altehrwürdiges Fachwerk und die Ausflugsnähe zeichnen das Flair dieses Ortsteils aus. Fällt jedoch in solch historischen Immobilien die massive Eichentür plötzlich unkontrolliert ins Schloss oder hakt das alte Kastenschloss irreparabel, muss schnellstmöglich ein Mechaniker ran, der sensibel mit der historischen Substanz umgeht. Hier übernimmt der heimatnahe <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Vetzberg</span> verlässlich das Steuer.</p>

<h3>Flotte Reaktion, keine Panik</h3>
<p>Dank gut ausgebauter Routen rund um den benachbarten Gleiberg verfehlen unsere Techniker ihr Ziel nie. Im Schnitt navigiert sich unser Einsatzteam in <span class="font-bold text-[color:var(--text-primary)]">14 Minuten</span> bis in die engen Gassen direkt vor Ihr Haus in Vetzberg. Im kalten Winter oder bei hereinbrechender Dunkelheit verspricht das ein enormes Aufatmen.</p>
...
<p>Wir honorieren das Vertrauen ländlicher Dörfer mit eisenharter Preis-Integrität. Am normalen Werktag tagsüber öffnen wir eine schlicht zugezogene Tür absolut beschädigungsfrei für einen Fixbetrag ab 99 Euro. Um die Fahrtkosten für den Sprinter abzugelten, berechnen wir stufenlose 15 Euro Zufuhr. Erstklassige handwerkliche Notöffnung darf und muss kalkulierbar sein und auch rund um die Burg Vetzberg.</p>`,
        ...
        content: {
            ...
            mainText: `<p>In den traditionsreichen Gassen von <span class="font-bold text-[color:var(--text-primary)]">Vetzberg</span> öffnen unsere sensiblen Techniker Türen mit extremem Fingerspitzengefühl und Respekt vor der Bausubstanz.</p>`,
    ...
    // ━━━━ HOHENAHR und 5 ORTSTEILE ━━━━
    {
        ...
        aboutText: `
<p>Weitläufig von schillernden Wäldern und Wiesen umschlossen, ruht das beschauliche <span class="font-bold text-[color:var(--text-primary)]">Ahrdt</span> im nördlichen Teil der Großgemeinde Hohenahr. In diesem äußerst familiären und naturbezogenen Refugium steht die Zeit oft ein kleines bisschen stiller als in den umliegenden Städten. Eine plötzlich verriegelte Haustür oder ein abgebrochener Schlüssel reißen diese Wohlfühlatmosphäre rasant ein. Genau an diesem Punkt tritt der in Wetzlar beheimatete <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Ahrdt</span> auf den Plan, um die ländliche Isolation mit blitzschnellem Service zu durchtrennen.</p>

<h3>Flotter Ritt auf der K-Straße</h3>
<p>Ländliche Gebiete sind für uns nie lästige Peripherie. Dank ausgeklügeltem Navi-Routing und motivierten Monteuren schieben wir uns über die umliegenden Landstraßen zügig nach vorn. Im Optimalfall dauert die Anreise in das tiefe Ahrdt lediglich knappe <span class="font-bold text-[color:var(--text-primary)]">16 Minuten</span>. Sie durchleben bei eiskaltem Regen also keine stundenlange Ungewissheit auf dem kalten Fußabtreter.</p>
...
<p>Gerade in kleinen Ortsteilen schlagen dubiose Fern-Dienste eiskalt mit erfundenen Fahrtenschlager-Gebühren zu. Unsere Firmen-Philosophie bricht damit rigoros: Liegt am Werktag eine unkompliziert zugefallene Tür an, rufen wir dafür unsere berühmten 99 Euro Festkosten auf. On top kommt nach Ahrdt nur die 15-Euro Fuhrparkpauschale, und das absolut deckelnd. Niemand fräst ohne Not und Einverständnis teure Edelstahlschlösser kaputt und wir setzen auf nachhaltiges Lockpicking.</p>`,
        ...
        content: {
            ...
            mainText: `<p>In der entspannten Ruhe von <span class="font-bold text-[color:var(--text-primary)]">Ahrdt</span> fungiert unser Wetzlarer Einsatzleiter als Ihr rettendes Sicherheitsnetz bei jeder Schlosspanik.</p>`,
    ...
    },
    {
        ...
        aboutText: `
<p>Als pulsierender Hauptort und Sitz der Gemeindeverwaltung von Hohenahr verschmilzt <span class="font-bold text-[color:var(--text-primary)]">Erda</span> ländliche Gelassenheit mit wichtiger lokaler Gewerbe- und Einzelhandelsstruktur. Doch auch in diesem belebten Mix schlägt der Teufel oft im Detail zu: Ein verlorener Schlüsselbund beim Einkaufen oder eine vor der Nase zuschlagende Haustür lassen den Tag panisch entgleisen. Gut, dass das bestens vernetzte Team vom Wetzlarer <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Erda</span> für jede Schließanlagen-Anomalie direkt ansprechbar ist.</p>

<h3>Schnurgerade ins Zentrum</h3>
<p>Wenn das Telefon klingelt, sitzen unsere Monteure blitzschnell im Fahrzeug. Die Strecke hoch nach Erda wird über die L3053 zügig und abseits der großen Verkehrsknoten abgefahren. So stempeln wir unsere Ankunftszeit vor Ort durchschnittlich nach bemerkenswerten <span class="font-bold text-[color:var(--text-primary)]">15 Minuten</span>. Gerade vor Praxen, bei Büros oder an frostigen Tagen zählt jede Sekunde.</p>
...
<p>Erda wird auf unserer Tarif-Karte als vollumfänglicher Standardort bedient. Bei schlicht geschlossenen (nicht mechanisch versperrten) Hausportalen liegt dieser Betrag für Sie kalkulierbar bei 99 Euro Festpreis tagsüber. Zuzüglich fordern wir ehrliche 15 Euro Zufuhrpauschale, um den KFZ-Betrieb zu finanzieren. Auch wenn unser Techniker gezwungen ist, an einer gewerblichen Sicherheitstür zu zerspanen, hören Sie von uns exakt den Folgepreis, ehe das Bohrwerk läuft. Vertrauen durch Ehrlichkeit.</p>`,
        ...
        content: {
            ...
            mainText: `<p>In <span class="font-bold text-[color:var(--text-primary)]">Erda</span>, dem lebendigen Herzstück von Hohenahr, leisten wir Aufsperrhilfe der Spitzenklasse und verlässlich ohne jegliche Knebelverträge.</p>`,
...
<p>Dorfbewohner tappen oft in die Kostenfalle von weit entfernten Vermittler-Zentralen. Unsere Wetzlarer Strategie lautet: 99 Euro für die zugezogene Wohnungs- oder Haustür auf glatter Tagesbasis. Zu dieser transparent kalkulierten Fix-Leistung gesellt sich nach Großaltenstädten ausschließlich eine geringe, statische Auto-Pauschale in Höhe von 15 Euro. Nichts ist versteckt, jede Eventualität offengelegt. Wir öffnen lieber spurlos, reparieren fair und montieren bei Bedarf hochwertigen Schloss-Ersatz direkt aus unserem Transporter.</p>`,
        ...
        content: {
            ...
            mainText: `<p>In der beschaulichen Stille von <span class="font-bold text-[color:var(--text-primary)]">Großaltenstädten</span> operieren unsere Servicetechniker als Fels in der Brandung und hochprofessionell, regional und zu humanen Dorf-Preisen.</p>`,
    ...
    },
    {
        ...
        aboutText: `
<p>Majestätisch thront <span class="font-bold text-[color:var(--text-primary)]">Hohensolms</span> als höchstgelegener und historisch markantester Ortsteil der Gemeinde Hohenahr. Umgeben von der weithin sichtbaren Burg Hohensolms pflegt dieser Ort eine tiefe Traditionsverbundenheit. Weht jedoch der raue Herbstwind kräftig über die Bergrücken und drückt das eigene Haustürblatt ins Schloss, offenbart die Idylle ihre Kehrseite. Ein abgebrochener Schlüssel bei Minusgraden erfordert keine Verzweiflung, sondern das rasche Einschreiten vom ortsnahen Wetzlarer <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Hohensolms</span>.</p>

<h3>Bergfahrt in Rekordzeit</h3>
<p>Unsere Leitstelle dirigiert die Servicekräfte für Hohensolms so, dass die Anstiege effizient gebündelt werden. Resultat: In rund <span class="font-bold text-[color:var(--text-primary)]">17 Minuten</span> parken unsere Einsatzwagen vor Ort in Ihrer Einfahrt oder am Burgfuß. Das Warten im eiskalten Burgwind minimieren wir auf den absoluten Bruchteil des branchenüblichen Durchschnitts.</p>
...
<p>Es existiert kein "Höhenmeter-Zuschlag". Transparenz ist das einzige, was zählt. Wenn die Falle (ohne aktives Verriegeln) ins geschlossene Schließblech gerutscht ist, rufen wir werktags tagsüber bescheidene 99 Euro Festpreis auf. Die Sprit-Pauschale nach Hohensolms macht magere 15 Euro aus. Wir verzichten radikal auf das stumpfe Aufbohren, solange das Material keinen tiefgreifenden, irreversiblen Defekt aufweist. In diesen extrem seltenen Fallen kommunizieren wir alle weiteren Schritte und Preise absolut haargenau voraus.</p>`,
        ...
        content: {
            ...
            mainText: `<p>In den historischen Gefilden von <span class="font-bold text-[color:var(--text-primary)]">Hohensolms</span> greift unser seriöses Wetzlarer Team auf feinfühlige Handwerksmethoden zurück und exklusiv und verlässlich.</p>`,
    ...
    },
    {
        ...
        aboutText: `
<p>Verborgen inmitten der mittelhessischen Höhenzüge von Hohenahr, bildet der Ortsteil <span class="font-bold text-[color:var(--text-primary)]">Mudersbach</span> eine absolute Oase der Natur- und Waldverbundenheit. Hier leben Familien, die den dörflichen Rückzug schätzen. Abgeschnitten darf man sich deshalb aber im Notfall nicht fühlen: Wer sich vor seinem Bauernhof oder seinem Eigenheim ausgesperrt wiederfindet und während der Kamin drinnen noch brennt und benötigt Soforthilfe. Der bestens vernetzte <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Mudersbach</span>, als direkter Ableger der Wetzlarer Zentrale, löst derartige blockierte Türen rasch, präzise und zu ehrlichen Landtarifen.</p>

<h3>Pünktlich am Rande der Gemeinde</h3>
<p>Ländliche Abgeschiedenheit erfordert starke Routing-Kompetenz. Unsere Fahrzeuge kennen jede Nebenstraße und benötigen von Wetzlar aus maximal etwa <span class="font-bold text-[color:var(--text-primary)]">18 Minuten</span> in das Herz von Mudersbach. So sind stundenlanges Frösteln im Freien und nervenzehrendes Warten auf auswärtige Monteure hier niemals ein Thema.</p>
...
<p>Böse Überraschungen oder fiktive "Anfahrtsgebiete" (Tarif-Zonen) existieren bei uns bewusst nicht. Eine klassische Tag-Öffnung für lediglich ins Schloss gefallene Portale fakturieren wir zu humanen 99 Euro. Darauf packen wir vollkommen transparent exakt 15 Euro für unseren gelisteten KFZ-Anfahrtsweg. Versagende Bauteile (Schließkasten verklemmt) fräsen wir nach genauer Rücksprache fair und exakt aus. Mudersbach kann sich auf unsere regionalen Handwerkerwerte komplett verlassen.</p>`,
        ...
        content: {
            ...
            mainText: `<p>In den grünen Winkeln von <span class="font-bold text-[color:var(--text-primary)]">Mudersbach</span> rücken unsere fachmännischen Monteure ohne Verzug aus, um Ihnen Stress und Beschädigungen zu ersparen.</p>`,
...
<p>Schlüsseldienste sind Vertrauenssache. Damit keine Abzock-Summen entstehen, operieren wir mit unverfälschten Werten. Ist die Haus- oder Wohnungstür in Stockhausen schlichtweg unbeabsichtigt zugefallen, deblockieren wir die Falle werktags (tagsüber) zu humanen 99 Euro. Auf den schnellen Weg über die Bundesstraße entfallen lediglich starre 15 Euro Fahrpauschale. Unsere Techniker greifen erst dann zum Stahl-Bohrer, wenn tiefere Mechanikschäden es unabwendbar fordern und und immer in enger Kommunikation mit Ihnen.</p>`,
        ...
        content: {
            ...
            mainText: `<p>Direkt an der Lahn operierend, garantiert unser <span class="font-bold text-[color:var(--text-primary)]">Stockhausener</span> Einsatzdienst handwerkliche Bravour ohne Schmierereien oder undurchsichtige Rechnungen.</p>`,
