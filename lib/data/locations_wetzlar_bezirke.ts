...
<p>Auch die Wetzlarer Gemarkung um die Stoppelberger Hohl genießt den VIP-Status unserer Kernstadt: Wir stornieren vollumfänglich jegliche Anfahrtskosten. Wir berechnen für Standard-Türöffnungen an Wochentagen tagsüber einen fixen <strong>Ab-Preis von 99 Euro</strong>.</p>`,
    ...
    },
    {
        ...
        logistics: { drivingTimeMinutes: "3-5", distanceFromHQ: 1 },
        pricing: { basePrice: 99, basePriceNight: 119, basePriceWeekend: 179, travelCost: 0, travelCostText: "Keine Anfahrtskosten (Kernstadt Wetzlar)" },
        seo: { metaTitle: "Schlüsseldienst Silhöfer Aue Wetzlar — In 3 Min. da | 99€", metaDescription: "Schlüsseldienst für die Silhöfer Aue und das Westend in Wetzlar. In 3 Min. da, ab 99€ Festpreis. Jetzt: 06441-8056279" },
        // === 10X ERWEITERUNG ===
