...
export const ring2Locations: LocationData[] = [
    // --- RING 2 (3-10 km) ---
    {
        ...
        aboutText: `
<p>Direkt nordwestlich an den Wetzlarer Kernbereich anschließend, erstreckt sich die lebendige Stadt <span class="font-bold text-[color:var(--text-primary)]">Aßlar</span>. Als Einfallstor in das Dilltal vereint Aßlar mit seinen rund 14.000 Einwohnern modernste industrielle Zentren in der Kernstadt mit tief ländlicher, bewaldeter Ausstrahlung in den hochgelegenen Ortsteilen <span class="font-bold text-[color:var(--text-primary)]">Werdorf, Berghausen, Kölschhausen, Bechlingen, Oberlemp und Bermoll</span>. Ob der Haustürschlüssel beim Schwimmbadbesuch in der "Laguna Aßlar" abhandenkam oder die schwere Holztür Ihres Einfamilienhauses in Bermoll vom starken Westerwald-Wind unwiderruflich ins Schloss gepresst wurde: Das Horrorszenario der verschlossenen Tür löst unser ansässiger, top-qualifizierter <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Aßlar</span> im Handumdrehen.</p>

<h3>Blitzschnelle Hilfe über die B277: Rekordzeit für Aßlar</h3>
<p>Da unsere Einsatzbasis unmittelbar angrenzt, ist Aßlar für uns kein Fremdgebiet, sondern tägliches Einsatzterrain. Über den autobahnähnlich ausgebauten Zubringer (B277) oder den kurzen Landstrich via Klein-Altenstädten navigieren unsere Handwerker staufrei und rasant zu Ihnen. Die versprochene Anfahrtszeit beläuft sich in der Kernstadt und Werdorf auf gerade mal <span class="font-bold text-[color:var(--text-primary)]">5 bis 10 Minuten</span>. Wer in strömendem Regen frierend vor der eigenen Haustür an der Dill ausharren muss, weiß solche echten Reaktionszeiten ohne Fernvermittlung zu schätzen.</p>
...
`,
    ...
    },
    {
        ...
        aboutText: `
<p>Eingebettet ins idyllische Lahntal, westlich von Wetzlar, erstreckt sich die geschichtsträchtige <span class="font-bold text-[color:var(--text-primary)]">Stadt Solms</span> mit ihren rund 13.500 Einwohnern über fünf eigenständige, charakterstarke Ortsteile: <span class="font-bold text-[color:var(--text-primary)]">Burgsolms, Oberbiel, Niederbiel, Oberndorf und Albshausen</span>. Was Solms von vielen Nachbargemeinden abhebt, ist die faszinierende Verbindung aus lebendigem Bergbauerbe und verkörpert durch das deutschlandweit bekannte Besucherbergwerk <span class="font-bold text-[color:var(--text-primary)]">Grube Fortuna</span> in Oberbiel und klösterlicher Kulturlandschaft rund um das ehrwürdige <span class="font-bold text-[color:var(--text-primary)]">Kloster Altenberg</span> auf dem Michelsberg. Wenn in einer solch facettenreichen Gemeinde der Haustürschlüssel abhanden kommt oder ein Schloss seinen Dienst versagt, brauchen die Bewohner einen <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Solms</span>, der die Besonderheiten jedes einzelnen Ortsteils kennt.</p>

<h3>Direkte Lahntal-Route: In Minuten bei Ihnen</h3>
<p>Die verkehrstechnische Anbindung von Solms ist für unseren Einsatzdienst nahezu ideal. Über die <span class="font-bold text-[color:var(--text-primary)]">B49</span>, die sich als Hauptschlagader durchs Lahntal zieht, sowie die <span class="font-bold text-[color:var(--text-primary)]">L3020</span> erreichen unsere Monteure sowohl die höher gelegenen Siedlungen in Oberndorf als auch die ufernahen Wohngebiete in Niederbiel und Oberbiel zuverlässig in <span class="font-bold text-[color:var(--text-primary)]">8 bis 12 Minuten</span>. Diese Verlässlichkeit verdanken wir nicht nur der kurzen Distanz von etwa 8 Kilometern, sondern auch unserer intimen Kenntnis der lokalen Verkehrsführung und wo in der Rushhour Stau entsteht, welche Nebenstraße schneller führt und wo Baustellen den Weg versperren könnten.</p>

<h3>Von Fachwerk bis Neubau: Handwerk für jedes Schloss</h3>
<p>Die bauliche Vielfalt in Solms ist bemerkenswert. In <span class="font-bold text-[color:var(--text-primary)]">Burgsolms</span>, dem mit rund 4.500 Einwohnern größten Stadtteil und historischem Stammsitz der Grafen zu Solms, finden sich zahlreiche ältere Fachwerkhäuser mit teilweise jahrhundertealten, massiven Holztüren und komplizierten Kastenschlössern. In <span class="font-bold text-[color:var(--text-primary)]">Oberbiel</span> und <span class="font-bold text-[color:var(--text-primary)]">Niederbiel</span> dominieren solide Nachkriegs-Reihenhäuser und Mehrfamilienhäuser mit klassischen Profilzylindern. <span class="font-bold text-[color:var(--text-primary)]">Albshausen</span> wiederum bietet modernere Einfamilienhaussiedlungen mit aktuellen Mehrfachverriegelungen und Sicherheitsbeschlägen. Unsere Fachkräfte beherrschen all diese Varianten gleichermaßen souverän und vom behutsamen Öffnen einer antiken Langkammklinke bis zur Manipulation modernster elektronischer Zugangssysteme.</p>

<h3>Grube Fortuna, Kloster Altenberg & Sternwarte</h3>
<p>Solms ist keine gesichtslose Schlafstadt, sondern ein lebendiger Ort mit kulturellem Selbstbewusstsein. Das Besucherbergwerk <span class="font-bold text-[color:var(--text-primary)]">Grube Fortuna</span> zieht Familien und Geschichtsinteressierte aus der gesamten Region an. Das malerisch auf dem Michelsberg gelegene <span class="font-bold text-[color:var(--text-primary)]">Kloster Altenberg</span> bietet nicht nur einen atemberaubenden Blick über die Lahn, sondern beherbergt auch Konzerte und Veranstaltungen. In Burgsolms lädt die <span class="font-bold text-[color:var(--text-primary)]">Sternwarte</span> zu faszinierenden Himmelsbeobachtungen ein. Am Lahnufer erinnert in Niederbiel das <span class="font-bold text-[color:var(--text-primary)]">Schweitzer-Kreuz</span> und ein neugotisches gusseisernes Denkmal und an ein tragisches Fährunglück von 1881. Wer hier lebt, lebt bewusst und schätzt Qualität und auch bei der Wahl des Schlüsseldienstes.</p>

<h3>24/7 Notdienst und Auch nachts am Lahnufer</h3>
<p>Ein Schlüsselnotfall kennt keine Uhrzeit. Ob Sie nach einem späten Spaziergang entlang des Lahnuferwegs feststellen, dass Ihr Schlüssel fehlt, oder ob nachts im Gewerbegebiet ein Schloss blockiert: Unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsselnotdienst Solms</span> ist 24 Stunden am Tag erreichbar, an 365 Tagen im Jahr. Wir kommen auch an Feiertagen, bei Schneefall oder in den frühen Morgenstunden und zuverlässig, diskret und ohne Wucherpreise.</p>

<h3>Festpreise ohne Wenn und Aber</h3>
<p>Für eine einfache zugefallene Tür berechnen wir werktags tagsüber <span class="font-bold text-[color:var(--text-primary)]">fix 99 Euro</span>. Dazu kommt lediglich eine symbolische Anfahrtspauschale von 10 Euro, die für ganz Solms gilt und egal ob Burgsolms im Zentrum oder Oberndorf am Rand. Diese Transparenz garantieren wir Ihnen bereits am Telefon, bevor sich unser Techniker überhaupt auf den Weg macht. Keine überraschenden Aufschläge, keine erfundenen Materialkosten, keine Tricks. Solide Handwerkerleistung zum ehrlichen Preis.</p>
`,
    ...
    },
    {
        ...
        aboutText: `
<p>Eingebettet ins Lahntal zwischen den Oberzentren Wetzlar und Gießen, ist die Gemeinde <span class="font-bold text-[color:var(--text-primary)]">Lahnau</span> mit ihren rund 8.300 Einwohnern ein äußerst beliebter Wohnstandort. Die drei Ortsteile <span class="font-bold text-[color:var(--text-primary)]">Waldgirmes, Dorlar und Atzbach</span> verbinden ländliche Lebensqualität mit perfekter Verkehrsanbindung. Was Lahnau jedoch weit über die Region hinaus bekannt macht, ist eine archäologische Sensation: Das <span class="font-bold text-[color:var(--text-primary)]">Römische Forum in Waldgirmes</span> und der früheste Beleg für steinerne Stadtarchitektur in der Germania Magna aus der Zeit Kaiser Augustus', inklusive des spektakulären Fundes eines lebensgroßen bronzenen Pferdekopfes. Wenn in einer so geschichtsreichen Gemeinde die Haustür ins Schloss fällt, ist unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Lahnau</span> in Rekordzeit zur Stelle.</p>

<h3>5 bis 10 Minuten: Schneller geht es kaum</h3>
<p>Durch die optimale Lage direkt an der <span class="font-bold text-[color:var(--text-primary)]">B49</span> und die geringe Distanz von nur 7 Kilometern zu unserer Wetzlarer Basis gehört Lahnau zu unseren schnellsten Einsatzgebieten. In <span class="font-bold text-[color:var(--text-primary)]">5 bis 10 Minuten</span> stehen unsere Monteure vor Ihrer Tür und ob in Waldgirmes am Ortsrand, im historischen Kern von Dorlar oder in den Wohnstraßen von Atzbach. Diese Blitzreaktion ist besonders wertvoll, wenn Kinder allein im Haus sind, Essen auf dem Herd steht oder Sie im strömenden Regen draußen ausharren müssen.</p>

<h3>Römisches Forum, Klosterkirche & Lahnauen</h3>
<p>Lahnau ist kulturell und naturkundlich ein Juwel. In <span class="font-bold text-[color:var(--text-primary)]">Waldgirmes</span> dokumentiert das <span class="font-bold text-[color:var(--text-primary)]">Römische Forum</span> eine einzigartige Siedlung aus der Zeit um 4 v. Chr., die als frühester Beweis für römische Stadtplanung östlich des Rheins gilt. Das <span class="font-bold text-[color:var(--text-primary)]">Heimatmuseum Waldgirmes</span> im ehemaligen Schulhaus von 1840 ergänzt dieses Erbe mit Einblicken in regionale Handwerkskunst. In <span class="font-bold text-[color:var(--text-primary)]">Dorlar</span> zeugt die <span class="font-bold text-[color:var(--text-primary)]">frühgotische Klosterkirche</span> und errichtet nach 1218 als Teil des Prämonstratenserinnen-Klosters und von mittelalterlicher Baukunst. Und in <span class="font-bold text-[color:var(--text-primary)]">Atzbach</span> erstreckt sich das <span class="font-bold text-[color:var(--text-primary)]">Naturschutzgebiet Lahnauen</span> mit seinem berühmten Storchennest als wichtiges Rast- und Durchzugsgebiet für Wasservögel.</p>

<h3>Drei Ortsteile, ein Versprechen: Spurlos offen</h3>
<p>Die Bebauung in Lahnau ist typisch für eine suburbanisierte Lahntalgemeinde: <span class="font-bold text-[color:var(--text-primary)]">Waldgirmes</span> (ca. 3.300 Einwohner) und <span class="font-bold text-[color:var(--text-primary)]">Atzbach</span> (ca. 3.200 Einwohner) bieten vornehmlich Einfamilienhäuser und Doppelhaushälften mit modernen Schließsystemen. <span class="font-bold text-[color:var(--text-primary)]">Dorlar</span> (ca. 1.850 Einwohner) hat einen etwas älteren Gebäudebestand mit vereinzelten historischen Türen im Ortskern. Unser Versprechen gilt überall gleichermaßen: Bei zugefallenen Türen liegt unsere zerstörungsfreie Öffnungsrate bei nahezu allen. Kein Kratzer, kein beschädigter Zylinder, keine Folgekosten.</p>

<h3>24/7 Notdienst an 365 Tagen</h3>
<p>Die Pendlergemeinde Lahnau lebt im Takt von Wetzlar und Gießen. Viele Bewohner kommen erst spätabends nach Hause und und genau dann passieren die meisten Aussperrungen. Unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsselnotdienst Lahnau</span> ist deshalb rund um die Uhr einsatzbereit, auch an Sonn- und Feiertagen, bei Hitze und Frost. Verlassen Sie sich auf uns.</p>

<h3>Festpreise für gute Nachbarschaft</h3>
<p>Für eine einfache zugefallene Tür berechnen wir werktags tagsüber <span class="font-bold text-[color:var(--text-primary)]">fix 99 Euro</span>. Die Anfahrt nach Lahnau kostet nur <span class="font-bold text-[color:var(--text-primary)]">10 Euro</span> und für alle drei Ortsteile identisch. Diese Preise nennen wir Ihnen am Telefon, bevor unser Monteur losfährt. Keine Tricks, keine versteckten Kosten. Ehrliches Handwerk aus der direkten Nachbarschaft.</p>
`,
    ...
    },
    {
        ...
        aboutText: `
<p>Südlich von Wetzlar gelegen, ist die Gemeinde <span class="font-bold text-[color:var(--text-primary)]">Hüttenberg</span> mit ihren rund 10.500 Einwohnern weit über die Region hinaus als Hessens <span class="font-bold text-[color:var(--text-primary)]">Handkäse-Hauptstadt</span> bekannt und vier der landesweit sechs Handkäse-Produzenten haben hier ihren Sitz, darunter die berühmte Käserei Birkenstock mit 28 Sorten. Doch Hüttenberg ist weit mehr als Kulinarik: Sechs gewachsene Ortsteile und <span class="font-bold text-[color:var(--text-primary)]">Hochelheim/Hörnsheim (Kernort), Rechtenbach, Weidenhausen, Volpertshausen, Reiskirchen und Vollnkirchen</span> und bieten eine einzigartige Mischung aus ländlicher Idylle, historischen Schätzen und dichter Wohnbesiedlung. Wenn in dieser vertrauten Atmosphäre die Haustür ins Schloss fällt, ist unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Hüttenberg</span> in wenigen Minuten zur Stelle.</p>

<h3>L3360 direkt ins Herz von Hüttenberg</h3>
<p>Die <span class="font-bold text-[color:var(--text-primary)]">L3360</span> ist für unsere Einsatzfahrten nach Hüttenberg eine absolute Hausstrecke. Von der Wetzlarer Basis aus sind wir in <span class="font-bold text-[color:var(--text-primary)]">10 bis 15 Minuten</span> vor Ihrer Tür und ob im Verwaltungssitz Rechtenbach, in Hochelheim, im ländlichen Reiskirchen oder im kleinen Vollnkirchen. Diese Zuverlässigkeit ist für uns tägliche Routine: Wir kennen jede Abzweigung, jede Engstelle und jeden Schleichweg in der Gemeinde.</p>

<h3>Goethehaus, Gottfrieds Haus & uralte Hügelgräber</h3>
<p>Hüttenberg überrascht mit einer kulturellen Tiefe, die weit über den Handkäse hinausgeht. In <span class="font-bold text-[color:var(--text-primary)]">Volpertshausen</span> dient das <span class="font-bold text-[color:var(--text-primary)]">Goethehaus</span> als Heimatmuseum und erinnert an den berühmten Besuch des Dichters. <span class="font-bold text-[color:var(--text-primary)]">Rechtenbach</span> begeistert mit <span class="font-bold text-[color:var(--text-primary)]">„Gottfrieds Haus"</span>, einem sorgfältig renovierten Fachwerkhaus von 1807, das den typischen „Hessenmann" der regionalen Fachwerkbaukunst zeigt. In der Umgebung finden sich <span class="font-bold text-[color:var(--text-primary)]">zweieinhalbtausend Jahre alte Hügelgräber</span>, die von keltischer Besiedlung zeugen. In <span class="font-bold text-[color:var(--text-primary)]">Hochelheim</span> mahlen die historische Kunstmühle und Dorfmühle seit Generationen. Für unsere Techniker bedeutet diese architektonische Vielfalt: Wir treffen auf alles und von antiken Kastenschlössern an Fachwerktüren bis zu modernen Mehrfachverriegelungen in Neubauten.</p>

<h3>6 Ortsteile, eine Qualität</h3>
<p>Der <span class="font-bold text-[color:var(--text-primary)]">Kernort Hüttenberg</span> (Hochelheim/Hörnsheim) bildet das Zentrum mit seiner dichten Mischung aus Einfamilienhäusern und älteren Siedlungsbauten. <span class="font-bold text-[color:var(--text-primary)]">Rechtenbach</span>, wo auch die Gemeindeverwaltung ihren Sitz hat, ist der bevölkerungsreichste Ortsteil. <span class="font-bold text-[color:var(--text-primary)]">Weidenhausen</span> mit seiner alten evangelischen Kirche, das kulturell bedeutsame <span class="font-bold text-[color:var(--text-primary)]">Volpertshausen</span>, das beschauliche <span class="font-bold text-[color:var(--text-primary)]">Reiskirchen</span> und das ländliche <span class="font-bold text-[color:var(--text-primary)]">Vollnkirchen</span> komplettieren das Gemeindegebiet. Für alle sechs Ortsteile gilt: identische Anfahrtskosten, identische Reaktionszeit, identische handwerkliche Qualität.</p>

<h3>24/7 Notdienst an 365 Tagen</h3>
<p>Ob mitten in der Nacht in Rechtenbach, am frühen Sonntagmorgen in Hochelheim oder an einem Feiertag in Vollnkirchen: Unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsselnotdienst Hüttenberg</span> operiert lückenlos, das ganze Jahr über. Wir lassen Sie niemals im Stich.</p>

<h3>Transparenz wie beim Handkäse: Was draufsteht, ist drin</h3>
<p>So wie der Hüttenberger Handkäse für Ehrlichkeit und handwerkliche Tradition steht, stehen wir für transparente Preise: Für eine zugefallene Tür berechnen wir werktags tagsüber <span class="font-bold text-[color:var(--text-primary)]">fix 99 Euro</span>. Die Anfahrt nach Hüttenberg kostet <span class="font-bold text-[color:var(--text-primary)]">15 Euro</span>. Das erfahren Sie am Telefon, bevor unser Monteur losfährt. Keine versteckten Kosten, keine Tricks, keine Wucherpreise.</p>
`,
    ...
    },
    {
        ...
        aboutText: `
<p>Im Herzen des Gladenbacher Berglands, auf Höhen zwischen 260 und 442 Metern, erstreckt sich die Gemeinde <span class="font-bold text-[color:var(--text-primary)]">Hohenahr</span> mit ihren rund 4.900 Einwohnern über eine waldreiche Landschaft, die zu 42 Prozent aus Mischwald besteht. Sechs eigenständige Ortsteile und <span class="font-bold text-[color:var(--text-primary)]">Erda, Hohensolms, Altenkirchen, Mudersbach, Groß-Altenstädten und Ahrdt</span> und bilden ein weitläufiges Gemeindegebiet im <span class="font-bold text-[color:var(--text-primary)]">Naturpark Lahn-Dill-Bergland</span>. Die Abgeschiedenheit und Naturverbundenheit dieser Gemeinde macht sie zum idealen Wohnort für Ruhesuchende und doch wenn der Schlüssel verloren geht oder die Tür ins Schloss fällt, braucht man einen <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Hohenahr</span>, der schnell und zuverlässig kommt.</p>

<h3>8 bis 12 Minuten trotz Bergland</h3>
<p>Trotz der hügeligen Topografie erreichen unsere Monteure über die <span class="font-bold text-[color:var(--text-primary)]">L3053</span> alle Hohenahrer Ortsteile in verlässlichen <span class="font-bold text-[color:var(--text-primary)]">8 bis 12 Minuten</span>. Unsere Disponenten kennen die Strecke durch das Bergland so gut, dass wir auch bei Schneeglätte oder Nebel zuverlässig vor Ihrer Tür stehen. <span class="font-bold text-[color:var(--text-primary)]">Erda</span>, der Verwaltungssitz und größte Ortsteil mit rund 2.050 Einwohnern, ist besonders schnell erreichbar.</p>

<h3>Burg Hohensolms & Altenberg-Aussichtsturm</h3>
<p>Geschichte ist in Hohenahr allgegenwärtig. Die <span class="font-bold text-[color:var(--text-primary)]">Burg Hohensolms</span> (Neu-Hohensolms), eine um 1350 erbaute Höhenburg auf dem Ramsberg in 435 Metern Höhe, thront majestätisch über dem gleichnamigen Ortsteil. Sie ersetzte die 1349 zerstörte Burg Alt-Hohensolms und wurde im 16. Jahrhundert zu Wohnzwecken ausgebaut. Auf dem <span class="font-bold text-[color:var(--text-primary)]">Altenberg</span> (442,2 m), dem höchsten Punkt der Gemeinde, bietet ein Aussichtsturm spektakuläre Panoramablicke über die Wetterau, den Hochtaunus, das Gießener Becken und den Hessischen Westerwald. In <span class="font-bold text-[color:var(--text-primary)]">Erda</span> ist die mittelalterliche <span class="font-bold text-[color:var(--text-primary)]">Wehrkirche</span>, dem Heiligen Nikolaus geweiht, ein architektonisches Zeugnis der Vergangenheit. <span class="font-bold text-[color:var(--text-primary)]">Altenkirchen</span> war historisch ein bedeutender Gerichtsort mit „Centgericht". Für unsere Techniker bedeutet diese Vielfalt: Wir treffen auf historische Schlösser an Burgmauern ebenso wie auf moderne Sicherheitstüren in Neubauten.</p>

<h3>Aartalsee & Naturparadies</h3>
<p>Der <span class="font-bold text-[color:var(--text-primary)]">Aartalsee</span>, der direkt an <span class="font-bold text-[color:var(--text-primary)]">Mudersbach</span> grenzt, ist eines der beliebtesten Naherholungsgebiete der Region und ideal zum Wandern, Radfahren und Verweilen. Die <span class="font-bold text-[color:var(--text-primary)]">Zweiburgentour</span> ab Hohensolms führt Wanderer durch die malerische Landschaft. Der gesamte Naturpark Lahn-Dill-Bergland mit seinen markierten Wanderwegen, der Minigolfanlage, dem Freischwimmbad und sogar einem <span class="font-bold text-[color:var(--text-primary)]">Ski- und Rodellift am Schlossberg</span> macht Hohenahr zum Ganzjahres-Freizeitziel.</p>

<h3>6 Ortsteile und vom Verwaltungssitz bis zum 238-Einwohner-Dorf</h3>
<p>Die Bandbreite der Ortsteile ist bemerkenswert: <span class="font-bold text-[color:var(--text-primary)]">Erda</span> mit ca. 2.050 und <span class="font-bold text-[color:var(--text-primary)]">Altenkirchen</span> mit ca. 775 Einwohnern sind die größten Zentren. <span class="font-bold text-[color:var(--text-primary)]">Hohensolms</span> (760 Einwohner) besticht durch seine Burganlage. <span class="font-bold text-[color:var(--text-primary)]">Groß-Altenstädten</span> (ca. 555), <span class="font-bold text-[color:var(--text-primary)]">Mudersbach</span> (ca. 515) und das winzige <span class="font-bold text-[color:var(--text-primary)]">Ahrdt</span> (ca. 240 Einwohner) vervollständigen das Gemeindegebiet. Für alle gilt: gleiche Anfahrtskosten, gleiche Qualität, gleiche Zuverlässigkeit.</p>

<h3>24/7 Notdienst an 365 Tagen</h3>
<p>Gerade in einer so ländlichen Gemeinde ist die Erreichbarkeit eines zuverlässigen Notdienstes Gold wert. Unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsselnotdienst Hohenahr</span> steht Ihnen rund um die Uhr zur Verfügung und auch nachts um 2 Uhr im verschneiten Ahrdt, am Sonntagmorgen in Mudersbach oder an einem Feiertag in Erda.</p>

<h3>Ehrliche Preise für ehrliche Bergland-Nachbarn</h3>
<p>Für eine einfache zugefallene Tür berechnen wir werktags tagsüber <span class="font-bold text-[color:var(--text-primary)]">fix 99 Euro</span>. Die Anfahrt nach Hohenahr kostet <span class="font-bold text-[color:var(--text-primary)]">15 Euro</span> und pauschal für alle sechs Ortsteile. Sie erfahren den Gesamtpreis am Telefon, bevor unser Monteur losfährt. In einer Gemeinschaft, die auf Vertrauen und Nachbarschaftshilfe setzt, sind wir der Schlüsseldienst, der dieses Vertrauen verdient.</p>
`,
