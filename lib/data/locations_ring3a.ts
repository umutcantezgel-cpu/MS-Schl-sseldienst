...
export const ring3LocationsA: LocationData[] = [
    // --- RING 3 (10-20 km) Teil 1 ---
    {
        ...
        aboutText: `
<p>Mit der <span class="font-bold text-[color:var(--text-primary)]">Justus-Liebig-Universität</span>, der <span class="font-bold text-[color:var(--text-primary)]">Technischen Hochschule Mittelhessen (THM)</span> und knapp 90.000 Einwohnern ist <span class="font-bold text-[color:var(--text-primary)]">Gießen</span> die pulsierende Universitätsstadt Mittelhessens und das Oberzentrum der Region. Tausende Studentenzimmer, weitläufige Altbau-Viertel im Bereich <span class="font-bold text-[color:var(--text-primary)]">Selzerweg und Ludwigsplatz</span>, moderne Neubauten am Stadtrand und historische Fachwerkhäuser in der Altstadt bilden ein architektonisches Mosaik, das seinesgleichen sucht. Für unseren <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Gießen</span> bedeutet das: Wir treffen auf eine enorme Bandbreite an Schlössern, von einfachen WG-Türen bis zu High-End-Sicherheitssystemen in Gewerbeimmobilien.</p>

<h3>15 bis 20 Minuten: Schnell in der Lahnstadt</h3>
<p>Dank optimaler Verkehrsanbindungen über die <span class="font-bold text-[color:var(--text-primary)]">B49</span> und <span class="font-bold text-[color:var(--text-primary)]">A480</span> stehen unsere Monteure in aller Regel in <span class="font-bold text-[color:var(--text-primary)]">15 bis maximal 20 Minuten</span> überall in Gießen und ob am Berliner Platz, in der Weststadt, in Wieseck oder im Philosophenwald. Wir kennen den Gießener Stadtverkehr wie unsere Westentasche und wählen stets die schnellste Route.</p>

<h3>Studenten, Altbauten & Gründerzeit</h3>
<p>Gießen hat den höchsten Studentenanteil aller deutschen Städte vergleichbarer Größe. Das bedeutet: Tausende WG-Zimmer, häufige Mieterwechsel und entsprechend viele Aussperrungen. Wir bieten <span class="font-bold text-[color:var(--text-primary)]">studentenfreundliche Festpreise</span> und öffnen WG-Türen, ohne dass die Kaution gefährdet wird. Die prächtigen <span class="font-bold text-[color:var(--text-primary)]">Gründerzeit-Altbauten</span> im Selzerweg-Viertel und rund um den Ludwigsplatz stellen mit ihren historischen Schlössern und schweren Holztüren besondere Anforderungen und die unsere Techniker mit Spezialausrüstung und Fingerspitzengefühl meistern.</p>

<h3>Mathematikum, Botanischer Garten & Schiffenberg</h3>
<p>Gießen ist kulturell lebendig: Das <span class="font-bold text-[color:var(--text-primary)]">Mathematikum</span> als erstes mathematisches Mitmach-Museum der Welt, der <span class="font-bold text-[color:var(--text-primary)]">Botanische Garten</span> (einer der ältesten in Deutschland, gegründet 1609), die <span class="font-bold text-[color:var(--text-primary)]">Klosterruine Schiffenberg</span> und das <span class="font-bold text-[color:var(--text-primary)]">Oberhessische Museum</span> locken Besucher aus der gesamten Region. Auch die lebendige Kneipenszene und das rege kulturelle Leben machen die Stadt zu einem Anziehungspunkt und und überall dort, wo Menschen unterwegs sind, passieren Aussperrungen.</p>

<h3>24/7 Notdienst für die Universitätsstadt</h3>
<p>Gießen schläft nie: Vorlesungen bis spät in den Abend, Bibliotheksbesuche bis Mitternacht, Kneipentour am Wochenende. Unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsselnotdienst Gießen</span> ist deshalb rund um die Uhr einsatzbereit und auch nach einer langen Nacht, an Feiertagen, bei Gewitter und Schnee. Wir lassen keinen Gießener im Regen stehen.</p>

<h3>Transparente Preise gegen Callcenter-Betrug</h3>
<p>Gerade in der Universitätsstadt haben dubiose Callcenter-Schlüsseldienste traurige Berühmtheit erlangt. Wir sind das Gegenteil: Ein <span class="font-bold text-[color:var(--text-primary)]">regionaler Fachbetrieb</span> mit transparenten Festpreisen. Für eine zugefallene Tür berechnen wir werktags tagsüber <span class="font-bold text-[color:var(--text-primary)]">fix 99 Euro</span>. Die Anfahrt nach Gießen kostet <span class="font-bold text-[color:var(--text-primary)]">15 Euro</span>. Sie erfahren den Gesamtpreis am Telefon, bevor sich unser Monteur auf den Weg macht.</p>
`,
...
`,
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: "Ganz klares Nein. In nahezu alle der Routinefälle und wenn die Tür nur ins Schloss geknallt ist und bleibt der Zylinder intakt und nutzbar. Wir öffnen in Braunfels schonend über den Türfalz."
            }
        ],
    ...
    },
    {
        ...
        aboutText: `
<p>Zentral zwischen Wetzlar und Herborn an der <span class="font-bold text-[color:var(--text-primary)]">Dill</span> gelegen, ist die Gemeinde <span class="font-bold text-[color:var(--text-primary)]">Ehringshausen</span> mit ihren rund 9.400 Einwohnern eines der dynamischsten Gemeinwesen im Lahn-Dill-Kreis. Neun eigenständige Ortsteile und <span class="font-bold text-[color:var(--text-primary)]">Ehringshausen (Kernort), Katzenfurt, Daubhausen, Kölschhausen, Dillheim, Dreisbach, Breitenbach, Greifenthal und Niederlemp</span> und vereinen sich zu einer Gemeinde, die durch ihre hervorragende Verkehrsanbindung, ihre aktive Vereinslandschaft und ihre überraschend reiche Geschichte besticht. Wenn in einer so weitläufigen Gemeinde der Schlüssel verloren geht oder ein Schloss blockiert, brauchen die Bewohner einen <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Ehringshausen</span>, der jeden einzelnen Ortsteil kennt und in Minuten vor Ort ist.</p>

<h3>A45 und B277: Blitzschnell an der Dill</h3>
<p>Die Gemeinde Ehringshausen profitiert von einer doppelten Verkehrsanbindung, die auch unserem Notdienst zugutekommt: Die <span class="font-bold text-[color:var(--text-primary)]">B277</span> verläuft parallel zur Dill durchs Tal, während der <span class="font-bold text-[color:var(--text-primary)]">Autobahnanschluss Ehringshausen an der A45</span> (Sauerlandlinie) die Region an das überregionale Straßennetz anschließt. Von unserer Wetzlarer Basis aus nutzen unsere Monteure je nach Ortsteil die optimale Route und sind verlässlich in <span class="font-bold text-[color:var(--text-primary)]">10 bis 15 Minuten</span> bei Ihnen und egal ob im Kernort Ehringshausen, im geschäftigen Katzenfurt oder im abgelegenen Greifenthal.</p>

<h3>Wehrkirche, Georg-Stollen & Hugenottenmuseum</h3>
<p>Ehringshausen überrascht mit einer kulturellen Tiefe, die man in einer Pendlergemeinde nicht unbedingt erwartet. Die <span class="font-bold text-[color:var(--text-primary)]">spätgotische Wehrkirche</span> im Kernort, die majestätisch auf einem Olivin-Diabas-Felsen thront, ist ein architektonisches Juwel. Am östlichen Ortsrand öffnet sich der Eingang zum <span class="font-bold text-[color:var(--text-primary)]">Georg-Stollen</span>, einem historischen Bergwerkstunnel von 1880, der von der einst bedeutenden Erzabbautradition der Region zeugt. In <span class="font-bold text-[color:var(--text-primary)]">Daubhausen</span> beherbergt die „Alte Schule" das <span class="font-bold text-[color:var(--text-primary)]">Dorf- und Hugenottenmuseum</span>, das an die hugenottische Besiedlung des Ortsteils erinnert. <span class="font-bold text-[color:var(--text-primary)]">Kölschhausen</span> lockt mit „Köhler's" <span class="font-bold text-[color:var(--text-primary)]">Heimat- und Feuerwehrmuseum</span>, und in <span class="font-bold text-[color:var(--text-primary)]">Breitenbach</span> dokumentiert ein liebevoll gestaltetes Heimatmuseum das Dorfleben um 1900.</p>

<h3>9 Ortsteile und 9 verschiedene Türtypen</h3>
<p>Die bauliche Vielfalt über neun Ortsteile hinweg ist enorm. Im <span class="font-bold text-[color:var(--text-primary)]">Kernort Ehringshausen</span> (ca. 4.200 Einwohner) finden sich sowohl moderne Neubauzeilen mit Mehrfachverriegelungen als auch ältere Mehrfamilienhäuser mit Standard-Profilzylindern. <span class="font-bold text-[color:var(--text-primary)]">Katzenfurt</span>, der zweitgrößte Ortsteil mit rund 1.900 Einwohnern, bietet eine ähnlich dichte Bebauung. Die kleineren Ortsteile wie <span class="font-bold text-[color:var(--text-primary)]">Daubhausen</span> (ca. 460 Einwohner), <span class="font-bold text-[color:var(--text-primary)]">Dreisbach</span> (ca. 280) und <span class="font-bold text-[color:var(--text-primary)]">Greifenthal</span> (ca. 250) sind dagegen von ländlichen Eigenheimen mit teils älteren, massiven Holztüren geprägt. Unsere Techniker bringen für jede dieser Varianten das passende Spezialwerkzeug mit und vom filigranen Fallengleiter bis zum Präzisionsfräser für festsitzende Zylinder.</p>

<h3>24/7 Notdienst an 365 Tagen</h3>
<p>Die Gemeinde Ehringshausen ist ein echter Pendler-Hotspot: Viele Bewohner arbeiten in Wetzlar, Gießen oder im Rhein-Main-Gebiet und kommen erst spätabends nach Hause. Genau dann, in der Dunkelheit und Kälte, passieren die meisten Aussperrungen. Unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsselnotdienst Ehringshausen</span> ist deshalb rund um die Uhr einsatzbereit und auch nachts um 2 Uhr, an Sonn- und Feiertagen, bei Gewitter und Schneefall. Wir lassen Sie in keinem der neun Ortsteile im Stich.</p>

<h3>Ehrliche Preise, null Tricks</h3>
<p>Für eine einfache zugefallene Tür berechnen wir werktags tagsüber <span class="font-bold text-[color:var(--text-primary)]">fix 99 Euro</span>. Die Anfahrt in die Gemeinde Ehringshausen (alle neun Ortsteile eingeschlossen) kostet faire <span class="font-bold text-[color:var(--text-primary)]">15 Euro</span>. Punkt. Keine Zuschläge für Berghöhe, keine Fantasie-Materialkosten, keine Überraschungen auf der Rechnung. Sie erfahren den Gesamtpreis am Telefon, bevor sich unser Techniker auf den Weg macht. Wir sind das Gegenteil der dubiosen Callcenter-Schlüsseldienste, vor denen die Verbraucherzentrale Hessen zu Recht warnt.</p>
`,
    ...
    },
    {
        ...
        aboutText: `
<p>Am südwestlichen Rand des Lahn-Dill-Kreises, dort wo die sanften Hügel des Taunusvorlandes beginnen, liegt die Gemeinde <span class="font-bold text-[color:var(--text-primary)]">Schöffengrund</span> mit ihren rund 6.500 Einwohnern. Sechs eigenständige Ortsteile und <span class="font-bold text-[color:var(--text-primary)]">Schwalbach, Laufdorf, Niederwetz, Oberwetz, Niederquembach und Oberquembach</span> und bilden ein ländliches Gemeinwesen, das durch seine malerischen Fachwerkhäuser, den denkmalgeschützten Ortskern von Oberwetz und eine überraschend lebendige Museumslandschaft besticht. Wenn in dieser idyllischen Umgebung die Haustür ins Schloss fällt, ist unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsseldienst Schöffengrund</span> schnell zur Stelle.</p>

<h3>12 bis 15 Minuten in jeden Ortsteil</h3>
<p>Die teils höhergelegenen und versteckten Ortsteile des Schöffengrundes stellen viele überregionale Schlüsseldienste vor Navigationsherausforderungen. Nicht uns! Durch unsere lokale Präsenz und Ortskenntnis navigieren wir staufrei und sind in <span class="font-bold text-[color:var(--text-primary)]">12 bis 15 Minuten</span> direkt an Ihrer Tür und ob im zentral gelegenen Verwaltungssitz <span class="font-bold text-[color:var(--text-primary)]">Schwalbach</span> (ca. 1.900 Einwohner) oder im abgelegenen Oberwetz.</p>

<h3>Oberwetz unter Denkmalschutz & Motorradmuseum</h3>
<p>Was Schöffengrund kulturell besonders macht, ist die bemerkenswerte Erhaltung seiner historischen Substanz. Der gesamte <span class="font-bold text-[color:var(--text-primary)]">Ortskern von Oberwetz</span> steht als Gesamtanlage unter Denkmalschutz und ein seltenes Zeugnis dörflicher Baukultur im südlichen Kreisgebiet. <span class="font-bold text-[color:var(--text-primary)]">Laufdorf</span> begeistert mit gut erhaltenen Fachwerkhäusern aus dem 17. bis 19. Jahrhundert, einem historischen Backhaus und der berühmten Laufdorfer Linde. In <span class="font-bold text-[color:var(--text-primary)]">Niederwetz</span> überrascht das <span class="font-bold text-[color:var(--text-primary)]">Vincent-Motorradmuseum</span> und eine liebevoll kuratierte Sammlung historischer Motorräder, die Technikbegeisterte aus der ganzen Region anzieht. Die barocke <span class="font-bold text-[color:var(--text-primary)]">Evangelische Kirche Schwalbach</span> (1763-1767) mit ihrer charakteristischen Zwiebelhaube rundet das kulturelle Angebot ab.</p>

<h3>6 Ortsteile, ein Versprechen</h3>
<p><span class="font-bold text-[color:var(--text-primary)]">Schwalbach</span> als größter Ortsteil ist das administrative Herz der Gemeinde. <span class="font-bold text-[color:var(--text-primary)]">Laufdorf</span> (ca. 1.600 Einwohner) folgt als zweitgrößter Ort. <span class="font-bold text-[color:var(--text-primary)]">Niederwetz</span> (ca. 1.050 Einwohner) und <span class="font-bold text-[color:var(--text-primary)]">Oberwetz</span> (ca. 640 Einwohner) liegen etwas höher am Taunusrand. <span class="font-bold text-[color:var(--text-primary)]">Niederquembach und Oberquembach</span> vervollständigen als kleinere Ortsteile das Gemeindegebiet. Für alle sechs gilt: identische Anfahrtskosten, identische Reaktionszeit, identische Qualität.</p>

<h3>24/7 Notdienst an 365 Tagen</h3>
<p>In einer so ländlichen Gemeinde ist die Erreichbarkeit eines zuverlässigen Notdienstes besonders wichtig. Unser <span class="font-bold text-[color:var(--text-primary)]">Schlüsselnotdienst Schöffengrund</span> steht Ihnen rund um die Uhr zur Verfügung und auch bei Schneeglätte auf der Zufahrt nach Oberwetz, an einem Feiertag in Laufdorf oder mitten in der Nacht in Niederquembach.</p>

<h3>Ehrliche Festpreise für ehrliche Nachbarn</h3>
<p>Für eine einfache zugefallene Tür berechnen wir werktags tagsüber <span class="font-bold text-[color:var(--text-primary)]">fix 99 Euro</span>. Die Anfahrt in den Schöffengrund kostet <span class="font-bold text-[color:var(--text-primary)]">15 Euro</span> und pauschal für alle sechs Ortsteile. Den Gesamtpreis erfahren Sie am Telefon, bevor unser Monteur losfährt. Keine versteckten Zuschläge, auch nicht für die höher gelegenen Ortsteile.</p>
`,
