...
export const ring3eLocations: LocationData[] = [
    // ━━━━ EHRINGSHAUSEN — DAUBHAUSEN, DREISBACH, GREIFENTHAL ━━━━
    {
        ...
        fareInfo: "Die Strecke nach Daubhausen versehen wir mit einer geringfügigen ländlichen Zufuhr von exakt 15 Euro – vertraglich bindend und fair.",
        scenarios: [
...
<p>Uns ist wichtig: Kleinstdörfer werden von uns nicht stiefmütterlich oder gar durch erhöhte Tarife abgestraft. Unser Festpreis ab 89 Euro bei zugefallenen Bauelementen ist heilig – egal ob Stadtzentrum Wetzlar oder die Dreisbacher Ortseinfahrt. Lediglich 15 Euro für den Fuhrpark kommen hinzu. Für dieses Komplettpaket agieren wir zu nahezu hundert Prozent zerstörungsfrei und extrem sicherungserfahren.</p>`,
    ...
    },
    {
        ...
        fareInfo: "Da Greifenthal im tiefen Landbereich liegt, rechnen wir eine offene und ehrliche 15-Euro-Schutzgebühr für den Transportweg ab – keine Mondpreise.",
        scenarios: [
...
<p>In winzigen Landecken treiben unseriöse Betrüger oft ihr Unwesen, indem sie gigantische Abfahrtskosten simulieren. Für uns nicht akzeptabel: Wir verankern auf unserer Abrechnung einen Festbetrag mit Start bei 99 Euro. Darauf kommen simple 15 Euro KFZ-Pauschale. Zerstörungsfreie Tor- und Türöffnungen – wie von Zauberhand erledigt und immer fair im Ort.</p>`,
        localTestimonials: [
            ...
            { name: "Carsten K.", quote: "Ein Anruf am Samstagmorgen – Tür zu. Keine Hotline in Berlin, sondern ein Wetzlarer Meister, der sofort startete. Schloss unversehrt. Handwerkers-Ehre, die man selten findet.", rating: 5 }
        ],
        content: {
            ...
            service247: "Als Regionalexperte bedienen wir Greifenthal durch unseren 24-Stunden-Service – 365 Tage im Jahr."
        },
        faqs: [
    ...
    // ━━━━ HÜTTENBERG — HOCHELHEIM, HÖRNSHEIM, REISKIRCHEN, VOLLNKIRCHEN ━━━━
    {
        ...
        fareInfo: "Die extrem kurze Anfahrtsdistanz sorgt bei Hochelheim für eine lachhafte Fahrtkosten-Berechnung von flachen 15 Euro – fair und absolut nachvollziehbar.",
        scenarios: [
        ...
        aboutText: `
<p>Dicht an Hörnsheim geschmiegt bildet <strong>Hochelheim</strong> das pochende Verwaltungsherz der Gemeinde Hüttenberg – inklusive Rathaus und einer der Hauptverkehrsadern zwischen den Regionen Wetzlar und Gießen. Wer hier zu Hause ist, genießt städtische Vorzüge in einem behutsam gewachsenen, dörflichen Ambiente. Ärgerlich wird es erst dann, wenn plötzlich der Zugang zu den eigenen vier Wänden durch einen verlorenen Schlüssel oder ein klemmendes Türschloss verwehrt wird. An diesem Punkt schaltet sich der verlässliche <strong>Schlüsseldienst Hochelheim</strong> ein.</p>
...
<p>Im Bereich der Handwerkertarife herrschen oft unkalkulierbare Ängste. In Hochelheim verscheuchen wir diese Sorgen mit transparenten, unwiderruflichen Festkosten: Fällt In der Mittagszeit am Werktag die Tür unbeabsichtigt zu, belasten wir Sie exakt mit 99 Euro. Der Fuhrpark schlägt mit bescheidenen 15 Euro zu Buche. Verdeckte Posten existieren nicht, Barzahlungspflicht ebensowenig.</p>`,
    ...
    },
    {
        ...
        fareInfo: "Die Strecke von Wetzlar nach Hörnsheim versehen wir mit einer absolut ehrlichen Fahrtkostenpauschale von schlanken 15 Euro – keine unvorhersehbaren Zusatzkilometer.",
        scenarios: [
...
<p>Bei Ankunft beurteilen wir den Schließstand der Tür: Handelt es sich "nur" um ein Zufallen aus Unachtsamkeit, verbürgen wir uns für saubere, materialerhaltende Öffnungen zum Tages-Werktags-Preis von fairen 99 Euro. Auf Hörnsheim entfällt eine schmale 15-Euro Fuhrparkgebühr. Eine defekte oder hochsicher verriegelte Einheit erfordert Fräsen? Selbst dann beraten wir Sie im Vorfeld absolut verbindlich und verbauen langlebige BKS und ABUS Marken als Ersatz.</p>`,
        localTestimonials: [
            { name: "Familie v. D.", quote: "Der Techniker in Hörnsheim war unglaublich menschlich und verstand unseren Schock, als wir uns aussperrten. Mit einem speziellen Gerät glitt er in den Türschlitz und öffnete ohne Bohrmaschine. 114 Euro – absolut empfehlenswert.", rating: 5 },
        ...
        content: {
            ...
            service247: "Unsere telefonische Leitstelle verknüpft Einsätze nach Hörnsheim nahtlos rund um die Uhr – auch nachts."
        },
        faqs: [
    ...
    },
    {
        ...
        fareInfo: "Die Anreise nach Reiskirchen verbuchen wir mit dem extrem günstigen Dorftarif von 15 Euro – eine transparente Summe ohne Kleingedrucktes.",
        scenarios: [
...
<p>Kleine Ortsteile leiden bei Notdiensten oft unter Horrorpreisen wegen angeblicher "Fahrtwegzuschläge". Das unterbinden wir resolut: Das bloße Entriegeln zugefallener Frontaltüren beziffern wir an normalen Werktagen tagsüber auf strikte 99 Euro. Auf die Strecke nach Vollnkirchen addieren sich schlichtweg 15 Euro KFZ-Kosten. Versteckte Posten dulden wir ebensowenig, wie rücksichtsloses Fräsen an Türen, die sich auch schonend überwinden ließen.</p>`,
        localTestimonials: [
            { name: "Hans-Georg V.", quote: "Der Techniker kam in seiner Tour direkt von Wetzlar in unter 15 Minuten zu uns rüber nach Vollnkirchen. Total nett, hat mir kurz erklärt was er macht und zack – Tür unbeschädigt offen. Fairer 114 Euro Festpreis.", rating: 5 },
