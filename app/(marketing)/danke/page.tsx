...
export default function DankePage() {
  return (
    <div className="bg-[var(--surface-primary)] text-[color:var(--text-primary)] font-sans">
      ...
      <div className="absolute top-0 left-0 w-full px-4 pt-4 text-[10px] text-[color:var(--text-tertiary)]/40 pointer-events-none z-0">Vielen Dank für Ihre Anfrage | Schlüssel Schmiede. Vielen Dank für Ihre Anfrage!</div>
      {/* Hero */}
