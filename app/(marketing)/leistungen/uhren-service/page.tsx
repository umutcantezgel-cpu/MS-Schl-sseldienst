...
export default function UhrenServicePage() {
 ...
 return (
  <div className="bg-[var(--surface-primary)] text-[color:var(--text-primary)] font-sans">
   ...
   <div className="sr-only" aria-hidden="true">Uhren-Service & Batteriewechsel Wetzlar | Filiale. Uhrenservice Schnell & Einfach.</div>
   <script
   ...
   <PersonalizedCTA />
   <FinalCTA headline="Uhren-Service direkt im Ladengeschäft." benefits={["Schneller Batteriewechsel vor Ort","Armbänder kürzen und tauschen","Ohne Termin, sofort erledigt"]} buttonText="Uhren-Service anfragen" socialProof="Professioneller Uhren-Service in Wetzlar" subtitle="Batterien · Armbänder · Alle Uhrenmarken" />
  </div>
 );
}
