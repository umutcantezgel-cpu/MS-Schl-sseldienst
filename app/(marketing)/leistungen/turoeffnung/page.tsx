...
export const metadata = generateSharedMetadata({
  ...
  description: "Zugefallen oder abgeschlossen? | Zerstörungsfreie Türöffnung zu 99% | Zertifizierter Fachbetrieb in Wetzlar. In ca. 20 30 Min. vor Ort. 06441 8056279",
...
export default function TuroeffnungPage() {
 ...
 return (
  <div className="bg-[var(--surface-primary)] text-[color:var(--text-primary)] font-sans">
   ...
   <div className="sr-only" aria-hidden="true">Türöffnung Wetzlar | Zerstörungsfrei ab 99€ Festpreis. Schnell wieder im Warmen. Türöffnung in Wetzlar.</div>
   <script
   ...
   <section className="relative pt-32 pb-16 sm:pt-40 sm:pb-24 lg:pt-52 lg:pb-32 bg-gradient-to-b from-[var(--color-off-white)] to-white overflow-hidden">
    ...
    <div className="absolute inset-0 opacity-[0.18] sm:opacity-[0.22] bg-[url(/images/bg-tueroeffnung.png)] bg-cover bg-center"></div>
    ...
    <StaggerReveal className="mx-auto max-w-4xl" animation={entryAnimations.slideUpFade} staggerDelay={0.1}>
     ...
     <StaggerItem animation={entryAnimations.slideUpFade}>
      <div className="space-y-4">
        <FAQAccordion question="Was kostet eine Türöffnung in Wetzlar?" answer="Schlüssel Schmiede Wetzlar öffnet zugefallene Türen ab 99 Euro und abgesperrte Türen ab 129 Euro zum Festpreis und ohne versteckte Kosten und ohne Anfahrtsgebühren." />
