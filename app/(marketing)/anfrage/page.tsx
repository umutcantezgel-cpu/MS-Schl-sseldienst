...
export default function AnfragePage() {
  return (
    <div className="bg-[var(--surface-primary)] text-[color:var(--text-primary)] font-sans">
      ...
      <div className="sr-only" aria-hidden="true">Unverbindliches Angebot anfragen | Schlüsseldienst Wetzlar. Unverbindliche Angebot-Anfrage | Schlüsseldienst Wetzlar.</div>
      {/* Hero */}
