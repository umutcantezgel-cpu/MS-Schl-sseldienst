...
export const metadata: Metadata = {
    ...
    description: "Widerrufsbelehrung gemäß § 312g BGB. Informationen über Ihr Widerrufsrecht, Ausnahmen bei Notdiensten und das Muster-Widerrufsformular.",
}
        ...
        >
            ...
            <LegalSection id="3-ausuebung">
                ...
                <div className="bg-gray-50 p-6 rounded-xl my-4 text-base border border-gray-200">
                    ...
                    35576 Wetzlar<br />
                    Deutschland<br /><br />
                    Telefon: <Link href="tel:+4917824710037" className="text-[var(--action-primary)] hover:underline">0178 2471037</Link><br />
