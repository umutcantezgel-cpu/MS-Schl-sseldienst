    ...
    return (
        ...
        >
            ...
            <LegalSection id="3-preise">
                ...
                <p>3.4. <strong>Zuschläge für Ausfallzeiten:</strong> Findet der Einsatz außerhalb unserer werktäglichen Kernzeiten statt, fallen gestaffelte Aufschläge für die Gewährleistung der dauerhaften Rufbereitschaft an. Dies betrifft den Spätdienst (ab 20:00 Uhr, zzgl. 20,00 €) sowie den tiefen Nachtdienst (ab 22:00 Uhr, zzgl. 50,00 €). An Samstagen, Sonn- und bundeseinheitlichen Feiertagen greift ein pauschaler Aufschlag von 80,00 € für den Notbetrieb.</p>
            </LegalSection>
