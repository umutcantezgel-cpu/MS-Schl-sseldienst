...
export const metadata: Metadata = {
    ...
    description: "Unsere Allgemeinen Geschäftsbedingungen. Transparente Regeln für Türöffnungen, Notdiensteinsätze und Festpreise in Wetzlar und Umgebung.",
}
        ...
        >
            ...
            <LegalSection>
                <TLDRBox title="Wichtigste Punkte im Überblick" icon="info">
                    ...
                    <p>Bei sofort auszuführenden Notdiensten erlischt das 14-tägige <HoverGlossary explanation="Das gesetzliche Recht, einen Vertrag innerhalb von 14 Tagen zu widerrufen. Bei Notdiensten entfällt dieses Recht jedoch.">Widerrufsrecht</HoverGlossary> gemäß <strong><HoverGlossary explanation="Ein Paragraph im Bürgerlichen Gesetzbuch, der ausdrücklich regelt, dass bei zwingend bestellten Reparaturarbeiten kein Rücktrittsrecht besteht.">§ 312g Abs. 2 Nr. 11 BGB</HoverGlossary></strong>. Stornieren Sie den Auftrag erst, wenn unser Techniker bereits unterwegs oder vor Ort ist, fällt eine branchenübliche <strong><HoverGlossary explanation="Eine pauschale Entschädigung für die Zeit und Benzinkosten unseres Technikers, wenn er umsonst anreist.">Leerfahrtpauschale von 50,- €</HoverGlossary></strong> an.</p>
                </TLDRBox>
            </LegalSection>
            ...
            <LegalSection id="4-stornierung">
                ...
                <p>4.2. Hat der Techniker die Anfahrt zum Einsatzort bereits angetreten oder ist bereits dort eingetroffen, wird im Falle einer Stornierung durch den Kunden eine <strong><HoverGlossary explanation="Pauschale Entschädigung für den entstandenen Wegeausfall, da der Techniker in dieser Zeit keinen anderen Kunden bedienen konnte.">Leerfahrt-/Ausfallpauschale in Höhe von pauschal 50,00 € inkl. MwSt.</HoverGlossary></strong> in Rechnung gestellt.</p>
