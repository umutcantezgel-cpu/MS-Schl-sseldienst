    ...
    return (
        ...
        >
            ...
            <LegalSection id="3-preise">
                ...
                <p>3.3. <strong>Mobilitätspauschale:</strong> Unabhängig vom Leistungspreis wird eine Anfahrtspauschale erhoben, die sich an der Wegstrecke orientiert. Für Fahrten in Wetzlar und im Umkreis von ca. 15 km entfallen die Anfahrtskosten komplett (0,00 €). Bei weiteren Strecken über 15 km berechnen wir maximal 40,00 €. Die verbindliche Anfahrtsgebühr wird dem Kunden stets vorab am Telefon mitgeteilt.</p>
