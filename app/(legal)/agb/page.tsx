        ...
        >
            ...
            <LegalSection>
                <TLDRBox title="Wichtigste Punkte im Überblick" icon="info">
                    <p>Wir arbeiten mit <span className="font-semibold text-[color:var(--text-primary)]">transparenten Festpreisen ab 99,- € (inkl. 19% MwSt.)</span> zzgl. Anfahrt. Die Anfahrtskosten werden Ihnen immer <span className="font-semibold text-[color:var(--text-primary)]">vorab telefonisch genau genannt</span>.</p>
                    <p>Bei sofort auszuführenden Notdiensten erlischt das 14-tägige <HoverGlossary explanation="Das gesetzliche Recht, einen Vertrag innerhalb von 14 Tagen zu widerrufen. Bei Notdiensten entfällt dieses Recht jedoch.">Widerrufsrecht</HoverGlossary> gemäß <HoverGlossary explanation="Ein Paragraph im Bürgerlichen Gesetzbuch, der ausdrücklich regelt, dass bei zwingend bestellten Reparaturarbeiten kein Rücktrittsrecht besteht."><span className="font-semibold text-[color:var(--text-primary)]">§ 312g Abs. 2 Nr. 11 BGB</span></HoverGlossary>. Stornieren Sie den Auftrag erst, wenn unser Techniker bereits unterwegs oder vor Ort ist, fällt eine branchenübliche <HoverGlossary explanation="Eine pauschale Entschädigung für die Zeit und Benzinkosten unseres Technikers, wenn er umsonst anreist."><span className="font-semibold text-[color:var(--text-primary)]">Leerfahrtpauschale (Höhe je nach Einsatzzeit)</span></HoverGlossary> an.</p>
                </TLDRBox>
            </LegalSection>
            ...
            <LegalSection id="1-geltungsbereich">
                ...
                <div className="bg-gray-50 p-4 rounded-lg my-4 text-sm border border-gray-200">
                    <span className="font-semibold text-[color:var(--text-primary)]">Vertragspartner:</span><br />
            ...
            <LegalSection id="3-preise">
                ...
                <p>3.2. <span className="font-semibold text-[color:var(--text-primary)]">Grundtarif Türöffnung:</span> Für die Basis-Dienstleistung des Öffnens einer nicht-verschlossenen, sondern lediglich zugefallenen Haus- oder Wohnungstür berechnen wir innerhalb der Kernarbeitszeiten (Montag bis Freitag, 06:00 Uhr bis 19:59 Uhr) ein Festpreis-Honorar ab 99,00 € (brutto).</p>
                <p>3.3. <span className="font-semibold text-[color:var(--text-primary)]">Mobilitätspauschale:</span> Unabhängig vom Leistungspreis wird eine Anfahrtspauschale erhoben, die sich an der Wegstrecke orientiert. Für Fahrten in Wetzlar und im Umkreis von ca. 15 km entfallen die Anfahrtskosten komplett (0,00 €). Bei weiteren Strecken über 15 km berechnen wir maximal 40,00 €. Die verbindliche Anfahrtsgebühr wird dem Kunden stets vorab am Telefon mitgeteilt.</p>
                <p>3.4. <span className="font-semibold text-[color:var(--text-primary)]">Zuschläge für Ausfallzeiten:</span> Findet der Einsatz außerhalb unserer werktäglichen Kernzeiten (Montag bis Freitag, 06:00 bis 19:59 Uhr) statt, fallen leistungsabhängige Zuschläge für die Gewährleistung der dauerhaften Rufbereitschaft an. Die exakte Höhe des Zuschlags richtet sich nach der beauftragten Dienstleistung und dem Einsatzzeitpunkt (Spätdienst, Nachtdienst, Sonn-/Feiertag). Die verbindlichen Preise je Leistung und Zeitfenster sind jederzeit über unseren <Link href="/preise">Preiskalkulator</Link> einsehbar und werden dem Kunden stets vorab am Telefon mitgeteilt.</p>
            </LegalSection>
            ...
            <LegalSection id="4-stornierung">
                ...
                <p>4.2. Hat der Techniker die Anfahrt zum Einsatzort bereits angetreten oder ist bereits dort eingetroffen, wird im Falle einer Stornierung durch den Kunden eine <HoverGlossary explanation="Pauschale Entschädigung für den entstandenen Wegeausfall, da der Techniker in dieser Zeit keinen anderen Kunden bedienen konnte."><span className="font-semibold text-[color:var(--text-primary)]">Leerfahrt-/Ausfallpauschale von maximal 80,00 € inkl. MwSt.</span></HoverGlossary> je nach Anfahrtsweg in Rechnung gestellt.</p>
            ...
            <LegalSection id="5-zahlung">
                ...
                <p>5.1. Nach erbrachter Dienstleistung an der Einsatzstelle ist die Rechnungssumme grundsätzlich <span className="font-semibold text-[color:var(--text-primary)]">sofort und ohne Abzug</span> zur Zahlung fällig.</p>
            ...
            <LegalSection id="6-widerrufsrecht">
                ...
                <TLDRBox title="Wichtig: Notfalleinsätze" icon="help">
                    <p>Wenn Sie einen Handwerker dringend bestellen, um eine Reparatur durchzuführen (z.B. eine verschlossene Tür zu öffnen), gibt es <span className="font-semibold text-[color:var(--text-primary)]">kein 14-tägiges Rücktrittsrecht</span> auf diese spezifische Vor-Ort-Leistung.</p>
                </TLDRBox>
