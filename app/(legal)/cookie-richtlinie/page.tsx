        ...
        >
            ...
            <LegalSection>
                <TLDRBox title="Cookies auf einen Blick" icon="info">
                    <p>Wir verwenden <b>nur 5 Cookies</b> auf dieser Website und davon sind 3 technisch notwendig und 2 optional (Analyse). <b>Marketing-Cookies verwenden wir derzeit nicht aktiv.</b></p>
            ...
            <LegalSection id="1-was-sind-cookies">
                ...
                <p>Cookies können von der Website selbst gesetzt werden (<b>First-Party-Cookies</b>) oder von Drittanbietern, deren Dienste in die Website eingebunden sind (<b>Third-Party-Cookies</b>).</p>
                <p>Cookies allein können Sie <b>nicht identifizieren</b> und sie enthalten keine personenbezogenen Daten wie Name, E-Mail oder Adresse. Sie speichern lediglich anonyme oder pseudonyme Kennungen.</p>
            </LegalSection>

            <LegalSection id="2-welche-cookies">
                <h2 className="mt-0">2. Welche Cookies wir verwenden</h2>
                <p>Die folgende Tabelle listet <b>alle Cookies</b> auf, die unsere Website setzen kann. Diese Liste wird automatisch aus unserem zentralen Cookie-Inventar generiert und ist immer aktuell.</p>
            ...
            <LegalSection id="3-cookie-kategorien">
                ...
                <p>Diese Cookies sind <b>zwingend erforderlich</b>, damit die Website grundlegende Funktionen bereitstellen kann. Sie können nicht deaktiviert werden, da die Website ohne sie nicht korrekt funktioniert.</p>
                <p><b>Rechtsgrundlage:</b> Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse) i.V.m. § 25 Abs. 2 Nr. 2 TTDSG (technisch notwendig).</p>
                ...
                <p>Diese Cookies werden <b>nur nach Ihrer aktiven Einwilligung</b> gesetzt. Sie helfen uns zu verstehen, wie Besucher unsere Website nutzen, um sie kontinuierlich zu verbessern. Alle Daten werden anonymisiert erhoben.</p>
                <p><b>Rechtsgrundlage:</b> Art. 6 Abs. 1 lit. a DSGVO (Einwilligung) i.V.m. § 25 Abs. 1 TTDSG.</p>
                <ul className="mt-2 space-y-1.5 text-gray-600">
                ...
                <p>Marketing-Cookies ermöglichen die Einbindung externer Dienste und personalisierter Inhalte. <b>Wir setzen derzeit keine aktiven Marketing-Cookies.</b> Die Kategorie existiert für den Fall, dass zukünftig Dienste wie Terminbuchungs-Widgets eingebunden werden.</p>
            ...
            <LegalSection id="4-einstellungen">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 my-6">
                    ...
                    <ol className="space-y-2 text-gray-600 list-decimal list-inside">
                        ...
                        <li>Klicken Sie auf <b>&quot;Cookie-Einstellungen&quot;</b></li>
            ...
            <LegalSection id="5-cookies-loeschen">
                ...
                <p className="text-sm text-gray-500"><b>Hinweis:</b> Durch das Löschen von Cookies können gespeicherte Einstellungen (z.B. Ihre Cookie-Einwilligung und Schriftgröße) verloren gehen. Beim nächsten Besuch wird der Cookie-Banner erneut angezeigt.</p>
            </LegalSection>
            ...
            <LegalSection id="6-rechtsgrundlage">
                ...
                <ul className="mt-3 space-y-2 text-gray-600">
                    <li><b>§ 25 Abs. 2 Nr. 2 TTDSG</b> (Telekommunikation-Digitale-Dienste-Datenschutz-Gesetz) und Für technisch notwendige Cookies ist keine Einwilligung erforderlich, da sie für die Bereitstellung des vom Nutzer ausdrücklich gewünschten Dienstes unbedingt erforderlich sind.</li>
                    <li><b>§ 25 Abs. 1 TTDSG</b> und Für alle nicht technisch notwendigen Cookies (Analyse, Marketing) holen wir Ihre ausdrückliche Einwilligung ein, bevor diese gesetzt werden.</li>
                    <li><b>Art. 6 Abs. 1 lit. a DSGVO</b> und Die Verarbeitung personenbezogener Daten durch optionale Cookies erfolgt auf Grundlage Ihrer Einwilligung.</li>
                    <li><b>Art. 6 Abs. 1 lit. f DSGVO</b> und Die Verarbeitung durch essentielle Cookies erfolgt auf Grundlage eines berechtigten Interesses an der technischen Funktionsfähigkeit der Website.</li>
                </ul>
            </LegalSection>

            <LegalSection id="7-aenderungen">
                <h2 className="mt-0">7. Änderungen dieser Cookie-Richtlinie</h2>
                <p>Wir behalten uns vor, diese Cookie-Richtlinie bei Änderungen an den verwendeten Cookies oder der Rechtsgrundlage zu aktualisieren. Sollten wir neue Cookie-Kategorien einführen oder bestehende wesentlich ändern, wird automatisch ein <b>erneuter Einwilligungsprozess</b> (Re-Consent) ausgelöst.</p>
