...
export const metadata = generateSharedMetadata({
  title: "Barrierefreiheit — MS Schlüsseldienst Wetzlar",
  description:
    "Informationen zur Barrierefreiheit unserer Website. Wir setzen alle Maßnahmen um, damit jeder Mensch unsere Website vollständig nutzen kann.",
