   ...
   <section className="relative pt-[180px] pb-[var(--space-64)] lg:pt-[220px] lg:pb-[var(--space-96)] bg-[var(--color-charcoal-900)] overflow-hidden">
    ...
    <div className="container mx-auto px-[var(--section-px)] relative z-10 flex flex-col items-center text-center">
      ...
      <StaggerReveal className="mt-8 flex flex-col items-center" animation={entryAnimations.slideUpFade} staggerDelay={0.1}>
        ...
        <StaggerItem animation={entryAnimations.slideUpFade}>
          <h1 className="text-[36px] sm:text-[48px] lg:text-[60px] font-extrabold tracking-tight text-white leading-[1.1]">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3">
            <div className="flex items-center gap-4 bg-white/10 p-4 rounded-2xl border border-white/10 backdrop-blur-sm">
              ...
              <div className="flex flex-col items-start">
                ...
                <span className="text-sm font-medium text-white/70 mt-1">Google Rezensionen</span>
              </div>
            </div>
          </div>
        </StaggerItem>
       ...
       <StaggerItem key={review.name} animation={entryAnimations.slideUpFade}>
         <article className="rounded-[var(--radius-24)] bg-white p-8 shadow-[var(--elevation-2)] border border-[var(--border-subtle)] h-full flex flex-col justify-between hover:shadow-[var(--elevation-3)] transition-all group">
          <div>
            ...
            <time className="text-[13px] font-medium text-[var(--text-tertiary)] bg-[var(--surface-secondary)] px-3 py-1 rounded-full" dateTime={review.date}>{review.timeAgo}</time>
            </div>
            <blockquote className="text-[16px] text-[var(--text-secondary)] leading-relaxed relative">
