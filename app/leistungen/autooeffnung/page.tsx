...
export const metadata = generateSharedMetadata({
 title:"Autoöffnung — Alle Marken ohne Schäden",
 description:"Ausgesperrt aus dem Auto? MS Schlüsseldienst Wetzlar öffnet Ihr Fahrzeug schnell, sicher und garantiert kratzerfrei zum Festpreis. 24/7 Notdienst.",
   ...
   <section className="px-[var(--section-px)] py-[var(--section-py)] relative z-20">
    <div className="mx-auto max-w-4xl">
     <StaggerReveal className="prose prose-lg prose-slate mx-auto" animation={entryAnimations.slideUpFade} staggerDelay={0.1}>
      <StaggerItem animation={entryAnimations.slideUpFade}>
       <h2 className="text-[32px] md:text-[40px] font-extrabold tracking-tight text-[var(--text-primary)] leading-tight mb-6">
      ...
      <StaggerItem animation={entryAnimations.slideUpFade}>
       <div className="grid gap-8 sm:grid-cols-2 mb-16">
        <div className="flex gap-4 p-6 rounded-[var(--radius-24)] bg-white shadow-[var(--elevation-1)] border border-[var(--border-subtle)] hover:shadow-[var(--elevation-2)] transition-shadow">
         ...
         <div>
          <h3 className="text-xl font-bold text-[var(--text-primary)] mb-2">Alle Marken & Modelle</h3>
        ...
        <div className="flex gap-4 p-6 rounded-[var(--radius-24)] bg-white shadow-[var(--elevation-1)] border border-[var(--border-subtle)] hover:shadow-[var(--elevation-2)] transition-shadow">
         ...
         <div>
          <h3 className="text-xl font-bold text-[var(--text-primary)] mb-2">100% Zerstörungsfrei</h3>
          <p className="text-[16px] text-[var(--text-secondary)] leading-relaxed m-0">
      ...
      <StaggerItem animation={entryAnimations.slideUpFade}>
        <div className="rounded-[var(--radius-24)] bg-[var(--surface-secondary)] p-8 md:p-10 border border-[var(--border-subtle)] mb-16 relative overflow-hidden">
          ...
          <h3 className="text-[24px] font-bold text-[var(--text-primary)] mb-6">Der Ablauf</h3>
