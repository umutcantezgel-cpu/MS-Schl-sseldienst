...
describe("metadata.ts", () => {
    describe("generateSharedMetadata", () => {
        it("generates correct structured metadata for a standard page", () => {
            ...
            expect(meta.alternates?.canonical).toBe("https://www.schluesseldienst-wetzlar.de/preise");
            expect(meta.alternates?.languages?.["de-DE"]).toBe("https://www.schluesseldienst-wetzlar.de/preise");
            ...
            expect(meta.openGraph?.url).toBe("https://www.schluesseldienst-wetzlar.de/preise");
        });
        ...
        it("handles exactTitle prop correctly", () => {
            ...
            expect(meta.alternates?.canonical).toBe("https://www.schluesseldienst-wetzlar.de");
        });
